...
export class Blis {
    ...
    */
    ...
    public static async GetHistory(
        ...
        // Validate dialog against the current schema
        let validationErrors = this.DialogValidationErrors(trainDialog, entities, actions);
        ...
        let teachWithHistory: TeachWithHistory = {
            ...
            replayDiscrepancies: discrepancies,
