...
var BlisMemory = (function () {
    ...
    BlisMemory.prototype.SaveLookup = function (entityName) {
        try {
    ...
    BlisMemory.prototype.AddSaveLookup = function (entityName, apiActionId) {
        this.userState[Consts_1.UserStates.SAVELOOKUP][entityName] = apiActionId;
    };
    BlisMemory.prototype.RemoveSaveLookup = function (entityName) {
        try {
    ...
    BlisMemory.prototype.SetPage = function (page) {
        this.userState[Consts_1.UserStates.PAGE] = page;
    };
    BlisMemory.prototype.NextPage = function () {
        var page = this.userState[Consts_1.UserStates.PAGE];
        page.index++;
        return page;
    };
