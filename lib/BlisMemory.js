...
var BlisMemory = (function () {
    ...
    BlisMemory.SessionKey = function (session) {
        return Utils_1.Utils.HashCode(JSON.stringify(session.message.address.user)).toString();
    };
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, this.CueCommand().Clear()];
                    case 5:
                        _a.sent();
    ...
    BlisMemory.prototype.CueCommand = function () {
        CueCommand_1.CueCommand.memory = this;
        return CueCommand_1.CueCommand;
    };
