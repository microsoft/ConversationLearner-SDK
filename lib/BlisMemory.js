...
var BlisMemory = (function () {
    ...
    BlisMemory.prototype.RememberEntity = function (entityId, entityValue) {
        try {
    ...
    BlisMemory.prototype.ForgetEntity = function (entityId) {
        try {
            this.userState[Consts_1.UserStates.MEMORY].delete[entityId];
        }
        catch (error) {
            BlisDebug_1.BlisDebug.Error(error);
        }
