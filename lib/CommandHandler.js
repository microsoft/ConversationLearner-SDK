...
var CommandHandler = (function () {
    ...
    CommandHandler.HandleTestCommand = function (context, input, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, command, arg, arg2, arg3, result, result, result;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = input.split(' '), command = _a[0], arg = _a[1], arg2 = _a[2], arg3 = _a[3];
                        command = command.toLowerCase();
                        if (!(input == Command_1.TestCommands.ACTIONROUNDTRIP)) return [3 /*break*/, 2];
                        return [4 /*yield*/, Test_1.Test.T_ActionRoundtrip()];
                    case 1:
                        result = _b.sent();
                        cb([result.message]);
                        return [2 /*return*/];
                    case 2:
                        if (!(input == Command_1.TestCommands.APPROUNDTRIP)) return [3 /*break*/, 4];
                        return [4 /*yield*/, Test_1.Test.T_AppRoundtrip()];
                    case 3:
                        result = _b.sent();
                        cb([result.message]);
                        return [2 /*return*/];
                    case 4:
                        if (!(input == Command_1.TestCommands.ENTITYROUNDTRIP)) return [3 /*break*/, 6];
                        return [4 /*yield*/, Test_1.Test.T_EntityRoundtrip()];
                    case 5:
                        result = _b.sent();
                        cb([result.message]);
                        return [2 /*return*/];
