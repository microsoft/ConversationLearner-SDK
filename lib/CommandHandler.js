            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [3 /*break*/, 14];
                    case 3:
                        if (!(command == Command_1.LineCommands.ADDRESPONSE)) return [3 /*break*/, 4];
                        cb([Menu_1.Menu.AddResponse()]);
                        return [3 /*break*/, 14];
                    case 4:
                        if (!(command == Command_1.LineCommands.CUEAPICALLS)) return [3 /*break*/, 5];
                        cb([Menu_1.Menu.APICalls()]);
                        return [3 /*break*/, 14];
                    case 5:
                        if (!(command == Command_1.LineCommands.APPS)) return [3 /*break*/, 6];
                        cb([Menu_1.Menu.Apps()]);
                        return [3 /*break*/, 14];
                    case 6:
                        if (!(command == Command_1.LineCommands.CREATEAPP)) return [3 /*break*/, 7];
                        cb([Menu_1.Menu.CreateApp()]);
                        return [3 /*break*/, 14];
                    case 7:
                        if (!(command == Command_1.LineCommands.EDITAPICALL)) return [3 /*break*/, 9];
                    ...
                    case 8:
                        ...
                        return [3 /*break*/, 14];
                    case 9:
                        if (!(command == Command_1.LineCommands.EDITENTITY)) return [3 /*break*/, 11];
                    ...
                    case 10:
                        ...
                        return [3 /*break*/, 14];
                    case 11:
                        if (!(command == Command_1.LineCommands.EDITRESPONSE)) return [3 /*break*/, 13];
                        return [4 /*yield*/, context.client.GetAction(context.State(Consts_1.UserStates.APP), args)];
                    case 12:
                        action = _a.sent();
