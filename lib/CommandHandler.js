...
var CommandHandler = (function () {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 11:
                        appId = _a.sent();
                        return [4 /*yield*/, BlisClient_1.BlisClient_v1.client.GetAction_v1(appId, args)];
                    case 12:
                        action = _a.sent();
                    ...
                    case 14:
                        appId = _a.sent();
                        return [4 /*yield*/, BlisClient_1.BlisClient_v1.client.GetEntity_v1(appId, args)];
                    case 15:
                        entity = _a.sent();
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 8:
                        ...
                        BlisApp_1.BlisApp_v1.Delete_v1(context, arg, function (responses) {
                            cb(responses);
                        });
                        return [3 /*break*/, 17];
                    case 9:
                        ...
                        // Delete
                        TrainDialog_1.TrainDialog_v1.Delete(context, arg, function (dreponses) {
                            // Continue displaying remaining dialogs
                            TrainDialog_1.TrainDialog_v1.Get(context, true, function (responses) {
                    ...
                    case 10:
                        ...
                        TrainDialog_1.TrainDialog_v1.Edit(context, arg, function (responses) {
                            cb(responses);
                        });
                        return [3 /*break*/, 17];
                    case 11:
                    ...
                    case 13:
                        // Next page
                        _b.sent();
                        TrainDialog_1.TrainDialog_v1.Get(context, false, function (responses) {
                            cb(responses);
                        });
                        return [3 /*break*/, 17];
                    case 14:
    ...
    CommandHandler.ProcessCommand = function (context, command, args, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var memory, inTeach, _a, content, type, inDebug, memory_1, msg, results, card, _b, appname, luiskey, actionId, appid, entityId, actionId, content, actionId, content, _c, entityId, content, appId, appId, responses, memory_2, search, text;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        Action_1.Action_v1.GetAll_v1(context, null, args, function (responses) {
                            cb(responses);
                        });
                        return [3 /*break*/, 47];
                    case 2:
                    ...
                    case 9:
                        ...
                        Action_1.Action_v1.GetAll_v1(context, Consts_1.ActionTypes_v1.API, args, function (responses) {
                            cb(responses);
                        });
                        return [3 /*break*/, 47];
                    case 10:
                    ...
                    case 18:
                        ...
                        Action_1.Action_v1.GetAll_v1(context, Consts_1.ActionTypes_v1.TEXT, args, function (responses) {
                            cb(responses);
                        });
                        return [3 /*break*/, 47];
                    case 19:
                        if (!(command == Command_1.LineCommands.TEST)) return [3 /*break*/, 21];
                        return [4 /*yield*/, Test_1.Test.RunTest(args)];
                    case 20:
                        results = _d.sent();
                        cb(results);
                        return [3 /*break*/, 47];
                    case 21:
                        if (!inTeach) return [3 /*break*/, 25];
                        if (!(command == Command_1.LineCommands.ABANDON)) return [3 /*break*/, 23];
                    ...
                    case 25:
                        if (!(command == Command_1.LineCommands.ADDALTTEXT)) return [3 /*break*/, 26];
                        TrainDialog_1.TrainDialog_v1.Edit(context, args, function (responses) {
                            cb(responses);
                        });
                        return [3 /*break*/, 47];
                    case 26:
                        if (!(command == Command_1.LineCommands.APPS)) return [3 /*break*/, 27];
                        BlisApp_1.BlisApp_v1.GetAll_v1(context, args, function (responses) {
                            cb(responses);
                        });
                        return [3 /*break*/, 47];
                    case 27:
                        if (!(command == Command_1.LineCommands.CREATEAPP)) return [3 /*break*/, 28];
                        _b = args.split(' '), appname = _b[0], luiskey = _b[1];
                        BlisApp_1.BlisApp_v1.Create_v1(context, appname, luiskey, function (responses) {
                            cb(responses);
                        });
                        return [3 /*break*/, 47];
                    case 28:
                        if (!(command == Command_1.LineCommands.DELETEALLAPPS)) return [3 /*break*/, 29];
                        BlisApp_1.BlisApp_v1.DeleteAll_v1(context, function (responses) {
                            cb(responses);
                        });
                        return [3 /*break*/, 47];
                    case 29:
                        if (!(command == Command_1.LineCommands.DELETEACTION)) return [3 /*break*/, 30];
                        ...
                        return [3 /*break*/, 47];
                    case 30:
                        if (!(command == Command_1.LineCommands.DELETEAPP)) return [3 /*break*/, 31];
                        Utils_1.Utils.SendMessage(context, "Deleting app...");
                        appid = args.split(' ')[0];
                        BlisApp_1.BlisApp_v1.Delete_v1(context, appid, function (responses) {
                            cb(responses);
                        });
                        return [3 /*break*/, 47];
                    case 31:
                        if (!(command == Command_1.LineCommands.DELETEENTITY)) return [3 /*break*/, 32];
                        ...
                        return [3 /*break*/, 47];
                    case 32:
                        if (!(command == Command_1.LineCommands.DONE)) return [3 /*break*/, 33];
                        ...
                        return [3 /*break*/, 47];
                    case 33:
                        if (!(command == Command_1.LineCommands.EDIT)) return [3 /*break*/, 34];
                        cb(Menu_1.Menu.EditCards());
                        return [3 /*break*/, 47];
                    case 34:
                        if (!(command == Command_1.LineCommands.EDITAPICALL)) return [3 /*break*/, 35];
                        actionId = args.split(' ')[0];
                        ...
                        return [3 /*break*/, 47];
                    case 35:
                        if (!(command == Command_1.LineCommands.EDITRESPONSE)) return [3 /*break*/, 36];
                        actionId = args.split(' ')[0];
                        content = Utils_1.Utils.RemoveWords(args, 1);
                        ...
                        return [3 /*break*/, 47];
                    case 36:
                        if (!(command == Command_1.LineCommands.EDITENTITY)) return [3 /*break*/, 37];
                        ...
                        return [3 /*break*/, 47];
                    case 37:
                        if (!(command == Command_1.LineCommands.EXPORTAPP)) return [3 /*break*/, 38];
                        BlisAppContent_1.BlisAppContent.Export(context, function (responses) {
                            cb(responses);
                        });
                        return [3 /*break*/, 47];
                    case 38:
                        if (!(command == Command_1.LineCommands.IMPORTAPP)) return [3 /*break*/, 39];
                        ...
                        return [3 /*break*/, 47];
                    case 39:
                        if (!(command == Command_1.LineCommands.LOADAPP)) return [3 /*break*/, 41];
                    ...
                    case 40:
                        ...
                        return [3 /*break*/, 47];
                    case 41:
                        if (!(command == Command_1.LineCommands.START)) return [3 /*break*/, 42];
                        BlisSession_1.BlisSession.NewSession_v1(context, false, function (responses) {
                            cb(responses);
                        });
                        return [3 /*break*/, 47];
                    case 42:
                        if (!(command == Command_1.LineCommands.TEACH)) return [3 /*break*/, 44];
                        memory_2 = context.Memory();
                        return [4 /*yield*/, memory_2.TrainHistory().Clear()];
                    case 43:
                        _d.sent();
                        BlisSession_1.BlisSession.NewSession_v1(context, true, function (responses) {
                            cb(responses);
                        });
                        return [3 /*break*/, 47];
                    case 44:
                        if (!(command == Command_1.LineCommands.TRAINDIALOGS)) return [3 /*break*/, 46];
                        search = args.split(' ')[0];
                        // Set up pager
