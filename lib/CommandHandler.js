            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, memory.SetCueCommand(cueCommand)];
                    case 1:
                        _a.sent();
                    ...
                    case 10:
                        ...
                        return [4 /*yield*/, context.Memory().AppId()];
                    case 11:
                        appId = _a.sent();
                    ...
                    case 14:
                        appId = _a.sent();
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.GetEntity(appId, args)];
                    case 15:
                        entity = _a.sent();
            ...
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        Action_1.Action.Add_v1(context, null, Consts_1.ActionTypes.API, null, args, function (responses, actionId) {
                            cb(responses, Consts_1.TeachAction.PICKACTION, actionId);
                        });
                        return [3 /*break*/, 45];
                    case 3:
                        if (!(command == Command_1.LineCommands.ADDAPIAZURE)) return [3 /*break*/, 4];
                        Action_1.Action.Add_v1(context, null, Consts_1.ActionTypes.API, Consts_1.APITypes.AZURE, args, function (responses, actionId) {
                            cb(responses, Consts_1.TeachAction.PICKACTION, actionId);
                        });
                        return [3 /*break*/, 45];
                    case 4:
                        if (!(command == Command_1.LineCommands.ADDAPILOCAL)) return [3 /*break*/, 5];
                        Action_1.Action.Add_v1(context, null, Consts_1.ActionTypes.API, Consts_1.APITypes.LOCAL, args, function (responses, actionId) {
                            cb(responses, Consts_1.TeachAction.PICKACTION, actionId);
                        });
                        return [3 /*break*/, 45];
                    case 5:
                        if (!(command == Command_1.LineCommands.ADDRESPONSE)) return [3 /*break*/, 6];
                        Action_1.Action.Add_v1(context, null, Consts_1.ActionTypes.TEXT, null, args, function (responses, actionId) {
                            cb(responses, Consts_1.TeachAction.PICKACTION, actionId);
                        });
                        return [3 /*break*/, 45];
                    case 6:
                    ...
                    case 7:
                        ...
                        Action_1.Action.Add_v1(context, null, Consts_1.ActionTypes.API, Consts_1.APITypes.INTENT, args, function (responses, actionId) {
                            cb(responses, Consts_1.TeachAction.PICKACTION, actionId);
                        });
                        return [3 /*break*/, 45];
                    case 8:
                        ...
                        Entity_1.Entity.Add_v1(context, null, type, content, function (responses) {
                    ...
                    case 10:
                        ...
                        return [4 /*yield*/, memory.InDebug()];
                    case 11:
                        inDebug = _d.sent();
                        return [4 /*yield*/, memory.SetInDebug(!inDebug)];
                    case 12:
                        _d.sent();
                    ...
                    case 27:
                        ...
                        Action_1.Action.Delete_v1(context, actionId, function (responses) {
                            cb(responses);
                        });
                        return [3 /*break*/, 45];
                    case 28:
                    ...
                    case 32:
                        ...
                        Action_1.Action.Add_v1(context, actionId, Consts_1.ActionTypes.API, null, content, function (responses) {
                            cb(responses);
                        });
                        return [3 /*break*/, 45];
                    case 33:
                        ...
                        actionId = args.split(' ')[0];
                        content = Utils_1.Utils.RemoveWords(args, 1);
                        Action_1.Action.Add_v1(context, actionId, Consts_1.ActionTypes.TEXT, null, content, function (responses) {
                            cb(responses);
                        });
                        return [3 /*break*/, 45];
                    case 34:
                        ...
                        Entity_1.Entity.Add_v1(context, entityId, null, content, function (responses) {
                            cb(responses);
                        });
                        return [3 /*break*/, 45];
                    case 35:
                    ...
                    case 40:
                        ...
                        return [4 /*yield*/, memory_2.ClearTrainSteps()];
                    case 41:
                        _d.sent();
                    ...
                    case 42:
                        ...
                        search = args.split(' ')[0];
                        // Set up pager
                        return [4 /*yield*/, Pager_1.Pager.Init(context, search)];
                    case 43:
                        // Set up pager
                        _d.sent();
                        TrainDialog_1.TrainDialog.Get(context, true, function (responses) {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        cueCommand = _a.sent();
                        // Clear cue command
                        return [4 /*yield*/, memory.SetCueCommand(null)];
                    case 3:
                        // Clear cue command
                        _a.sent();
