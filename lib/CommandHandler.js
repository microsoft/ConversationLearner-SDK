...
var CommandHandler = (function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(command == Command_1.LineCommands.ADDAPIAZURE)) return [3 /*break*/, 1];
                        cb([Menu_1.Menu.AddAzureApi()]);
                        return [3 /*break*/, 15];
                    case 1:
                        if (!(command == Command_1.LineCommands.ADDAPILOCAL)) return [3 /*break*/, 2];
                        cb([Menu_1.Menu.AddLocalApi()]);
                        return [3 /*break*/, 15];
                    case 2:
                        if (!(command == Command_1.LineCommands.ADDENTITY)) return [3 /*break*/, 3];
                        cb([Menu_1.Menu.AddEntity()]);
                        return [3 /*break*/, 15];
                    case 3:
                        if (!(command == Command_1.LineCommands.ADDRESPONSETEXT)) return [3 /*break*/, 4];
                        cb([Menu_1.Menu.AddResponseText()]);
                        return [3 /*break*/, 15];
                    case 4:
                        if (!(command == Command_1.LineCommands.ADDRESPONSEINTENT)) return [3 /*break*/, 5];
                        cb([Menu_1.Menu.AddResponseIntent()]);
                        return [3 /*break*/, 15];
                    case 5:
                        if (!(command == Command_1.LineCommands.CUEAPICALLS)) return [3 /*break*/, 6];
                        cb([Menu_1.Menu.APICalls()]);
                        return [3 /*break*/, 15];
                    case 6:
                        if (!(command == Command_1.LineCommands.APPS)) return [3 /*break*/, 7];
                        cb([Menu_1.Menu.Apps()]);
                        return [3 /*break*/, 15];
                    case 7:
                        if (!(command == Command_1.LineCommands.CREATEAPP)) return [3 /*break*/, 8];
                        cb([Menu_1.Menu.CreateApp()]);
                        return [3 /*break*/, 15];
                    case 8:
                        if (!(command == Command_1.LineCommands.EDITAPICALL)) return [3 /*break*/, 10];
                    ...
                    case 9:
                        ...
                        return [3 /*break*/, 15];
                    case 10:
                        if (!(command == Command_1.LineCommands.EDITENTITY)) return [3 /*break*/, 12];
                    ...
                    case 11:
                        ...
                        return [3 /*break*/, 15];
                    case 12:
                        if (!(command == Command_1.LineCommands.EDITRESPONSE)) return [3 /*break*/, 14];
                        return [4 /*yield*/, context.client.GetAction(context.State(Consts_1.UserStates.APP), args)];
                    case 13:
                        action = _a.sent();
    ...
    CommandHandler.HandleCueCommand = function (context, input, cb) {
        ...
        if (command == Command_1.CueCommands.ADDRESPONSETEXT) {
            ...
            if (command == Command_1.CueCommands.ADDENTITY) {
    ...
    CommandHandler.HandleIntCommand = function (context, input, cb) {
        ...
        if (context.State(Consts_1.UserStates.TEACH)) {
            ...
            if (command == Command_1.IntCommands.DELETEAPP) {
                ...
                // Next page
                var page = context.Memory().NextPage();
                TrainDialog_1.TrainDialog.Get(context, page.search, page.index, false, function (responses) {
                    cb(responses);
                });
            }
            else if (command == Command_1.IntCommands.TRAINDIALOG_PREV) {
                // Next page
                var page = context.Memory().PrevPage();
                TrainDialog_1.TrainDialog.Get(context, page.search, page.index, false, function (responses) {
                    cb(responses);
                });
            }
    ...
    CommandHandler.ProcessCommand = function (context, command, args, cb) {
        ...
        if (command == Command_1.LineCommands.ACTIONS) {
            ...
            if (command == Command_1.LineCommands.APPS) {
                ...
                // Reset paging
                var page = new Page_1.Page(0, search);
                context.SetState(Consts_1.UserStates.PAGE, page);
                TrainDialog_1.TrainDialog.Get(context, page.search, page.index, true, function (responses) {
                    cb(responses);
                });
            }
            else {
