...
var BotMemory = (function () {
    ...
    BotMemory.PositiveName = function (negativeName) {
        if (negativeName.startsWith(Consts_1.ActionCommand.NEGATIVE)) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        botMemory = _a.sent();
                        return [2 /*return*/, this.EntityValue(botMemory, entityName)];
                }
            });
        });
    };
