        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, Object.keys(this.entityMap).map(function (val) { return this.entityMap[val].id; }, this)];
                }
            });
        });
    };
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        for (entityName in this.entityMap) {
                            memory.push(new blis_models_1.Memory({ entityName: entityName, entityValue: this.EntityValueAsString(entityName) }));
                        }
