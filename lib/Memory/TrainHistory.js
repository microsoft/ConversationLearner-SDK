...
var TrainHistory = (function (_super) {
    tslib_1.__extends(TrainHistory, _super);
    ...
    TrainHistory.Deserialize = function (type, text) {
        var trainHistory = _super.Deserialize.call(this, type, text);
...
tslib_1.__decorate([
    json_typescript_mapper_1.JsonProperty({ clazz: TrainStep_1.TrainStep, name: 'curStep' }),
    tslib_1.__metadata("design:type", TrainStep_1.TrainStep)
], TrainHistory.prototype, "curStep", void 0);
tslib_1.__decorate([
    json_typescript_mapper_1.JsonProperty({ clazz: TrainStep_1.TrainStep, name: 'lastStep' }),
    tslib_1.__metadata("design:type", TrainStep_1.TrainStep)
], TrainHistory.prototype, "lastStep", void 0);
tslib_1.__decorate([
    json_typescript_mapper_1.JsonProperty({ clazz: TrainStep_1.TrainStep, name: 'allSteps' }),
