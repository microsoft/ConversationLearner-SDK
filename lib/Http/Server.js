...
var Server = (function () {
    ...
    Server.Init = function () {
        ...
        this.server.put("/app/:appId/teach/:teachId/scorer", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var query, key, appId, teachId, uiScoreInput, _i, _a, textVariation, _b, _c, predictedEntity, teachResponse, extractResponse, memory, scoreInput, scoreResponse, memories, uiScoreResponse, error_43;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        for (_i = 0, _a = uiScoreInput.trainExtractorStep.textVariations; _i < _a.length; _i++) {
                            textVariation = _a[_i];
                            for (_b = 0, _c = textVariation.labelEntities; _b < _c.length; _b++) {
                                predictedEntity = _c[_b];
