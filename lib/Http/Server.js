...
var Server = (function () {
    ...
    Server.Init = function () {
         ...
         */
        this.server.post("/app/:appId/teach/${sessionId}/extractor", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var appId, sessionId, extractorStep, response, error_29;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        ...
                        extractorStep = json_typescript_mapper_1.deserialize(TrainDialog_2.ExtractorStep, req.body);
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.ExtractResponse(appId, sessionId, extractorStep)];
                    case 1:
                        response = _a.sent();
                        res.send(response);
                        return [3 /*break*/, 3];
         ...
         * trainDialog, and advancing the dialog. This may yield produce a new package.
         */
        this.server.post("/app/:appId/teach/${sessionId}/scorer", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var appId, sessionId, scorerResponse, response, error_30;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        ...
                        appId = req.params.appId;
                        sessionId = req.params.sessionId;
                        scorerResponse = json_typescript_mapper_1.deserialize(TrainDialog_2.ScorerResponse, req.body);
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.ScoreResponse(appId, sessionId, scorerResponse)];
                    case 1:
                        response = _a.sent();
                        res.send(response);
                        return [3 /*break*/, 3];
