...
var Server = (function () {
    ...
    Server.Init = function () {
        ...
        this.server.put("/app/:appId/teach/:teachId/extractor", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var query, key, appId, teachId, userInput, extractResponse, memory, suggestedEntity, memories, uiExtractResponse, error_42;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
        ...
        this.server.put("/app/:appId/teach/:teachId/scorer", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var query, key, appId, teachId, uiScoreInput, memory, teachResponse, extractResponse, scoreInput, scoreResponse, memories, uiScoreResponse, error_43;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 6, , 7]);
