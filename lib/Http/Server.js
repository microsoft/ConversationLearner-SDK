...
var Server = (function () {
    ...
    Server.HandleError = function (response, err) {
        ...
        if (err.body) {
            ...
            var msg = " " + (err.statusMessage ? err.statusMessage + "\n\n" : "") + (err.message ? err.message + "\n\n" : "") + (err.stack ? err.stack : "");
            error = new Error(msg);
        }
    ...
    Server.Init = function () {
        ...
        this.server.get("/bot", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                this.InitClient(); // TEMP
                try {
                    callbacks = Object.keys(BlisDialog_1.BlisDialog.Instance().apiCallbacks);
                    botInfo = new blis_models_1.BotInfo({ callbacks: callbacks });
                    res.send(json_typescript_mapper_1.serialize(botInfo));
                }
                catch (error) {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        query = req.getQuery();
                        key = req.params.key;
                        app = json_typescript_mapper_1.deserialize(blis_models_1.BlisAppBase, req.body);
        ...
        this.server.del("/app/:appId", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var key, appId, memory, curAppId, error_5;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.InitClient(); // TEMP
                    ...
                    case 3:
                        curAppId = _a.sent();
                        if (!(appId == curAppId)) return [3 /*break*/, 6];
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.InitClient(); // TEMP
                        appId = req.params.appId;
                        action = json_typescript_mapper_1.deserialize(blis_models_1.ActionBase, req.body);
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.InitClient(); // TEMP
                        appId = req.params.appId;
                        entity = json_typescript_mapper_1.deserialize(blis_models_1.EntityBase, req.body);
        ...
        this.server.post("/app/:appId/traindialog", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var appId, trainDialog, trainDialogId, error_29;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
        ...
        this.server.get("/app/:appId/traindialog/:trainDialogId", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var appId, trainDialogId, trainDialog, error_31;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.InitClient(); // TEMP
        ...
        this.server.del("/app/:appId/traindialog/:trainDialogId", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var appId, trainDialogId, error_32;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.InitClient(); // TEMP
        ...
        this.server.get("/app/:appId/traindialogs", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var query, appId, trainDialogs, error_33;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.InitClient(); // TEMP
        ...
        this.server.get("/app/:appId/trainDialogIds", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var query, appId, trainDialogIds, error_34;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.InitClient(); // TEMP
        ...
        this.server.post("/app/:appId/session", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var key, appId, sessionResponse, memory, error_35;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
        ...
        this.server.get("/app/:appId/session/:sessionId", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var appId, sessionId, response, error_36;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
        ...
        this.server.get("/app/:appId/sessions", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var query, appId, sessions, error_38;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.InitClient(); // TEMP
        ...
        this.server.get("/app/:appId/session", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var query, appId, sessionIds, error_39;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.InitClient(); // TEMP
        ...
        this.server.post("/app/:appId/teach", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var key, appId, teachResponse, memory, error_40;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
        ...
        this.server.get("/app/:appId/teach/:teachId", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var appId, teachId, response, error_41;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
        ...
        this.server.put("/app/:appId/teach/:teachId/extractor", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var key, appId, teachId, userInput, extractResponse, memory, suggestedEntity, memories, uiExtractResponse, error_42;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                    ...
                    case 1:
                        ...
                        memory = BlisMemory_1.BlisMemory.GetMemory(key);
                        if (!(extractResponse.predictedEntities.length == 0)) return [3 /*break*/, 3];
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3: return [4 /*yield*/, memory.BotMemory.DumpMemory()];
                    case 4:
                        memories = _a.sent();
        ...
        this.server.put("/app/:appId/teach/:teachId/scorer", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var key, appId, teachId, uiScoreInput, memory, extractResponse, scoreInput, scoreResponse, memories, uiScoreResponse, error_43;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 6, , 7]);
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, BlisDialog_1.BlisDialog.Instance().CallLuisCallback(extractResponse.text, extractResponse.predictedEntities, extractResponse.definitions.entities, memory)];
                    case 3:
                        scoreInput = _a.sent();
        ...
        this.server.post("/app/:appId/teach/:teachId/scorer", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var key, appId, teachId, trainScorerStep, scoredAction, teachResponse, memory, error_44;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
        ...
        this.server.del("/app/:appId/teach/:teachId", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var key, appId, teachId, save, response, memory, error_45;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.InitClient(); // TEMP
        ...
        this.server.get("/app/:appId/teaches", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var query, appId, teaches, error_46;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.InitClient(); // TEMP
        ...
        this.server.get("/app/:appId/teach", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var query, appId, teachIds, error_47;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.InitClient(); // TEMP
