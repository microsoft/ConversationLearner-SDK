...
var Server = (function () {
    ...
    Server.Init = function () {
        ...
        this.server.del("/app/:appId", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        app = _a.sent();
                        if (!(appId == app.appId)) return [3 /*break*/, 6];
        ...
        this.server.post("/app/:appId/teach/:teachId/scorer", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var key, appId, teachId, uiTrainScorerStep, scoredAction, teachResponse, memory, error_44;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        ...
                        appId = req.params.appId;
                        teachId = req.params.teachId;
                        uiTrainScorerStep = json_typescript_mapper_1.deserialize(blis_models_2.UITrainScorerStep, req.body);
                    ...
                    case 1:
                        ...
                        res.send(teachResponse);
                        memory = BlisMemory_1.BlisMemory.GetMemory(key);
                        BlisDialog_1.BlisDialog.Instance.TakeAction(scoredAction, memory, uiTrainScorerStep.entities);
                        return [3 /*break*/, 3];
                    case 2:
                        error_44 = _a.sent();
