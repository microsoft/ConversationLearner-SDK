...
var Server = (function () {
    ...
    Server.Init = function () {
        ...
        this.server.put("/app/:appId/teach/:teachId/scorer", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        memories = _a.sent();
                        uiScoreResponse = new blis_models_1.UIScoreResponse({ scoreInput: scoreInput, scoreResponse: scoreResponse, memories: memories });
        ...
        this.server.post("/app/:appId/teach/:teachId/scorer", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var query, key, appId, teachId, trainScorerStep, scoredAction, teachResponse, memory, error_45;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
