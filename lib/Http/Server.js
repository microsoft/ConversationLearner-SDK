...
var Server = (function () {
    ...
    Server.Init = function () {
        ...
        this.server.post("/app/:appId/teach/${sessionId}/extractor", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var appId, sessionId, extractorStep, response, error_18;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        ...
                        extractorStep = json_typescript_mapper_1.deserialize(TrainDialog_1.ExtractorStep, req.body);
        ...
        this.server.post("/app/:appId/teach/${sessionId}/scorer", function (req, res, next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var appId, sessionId, scorerResponse, response, error_19;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        ...
                        appId = req.params.appId;
                        sessionId = req.params.sessionId;
                        scorerResponse = json_typescript_mapper_1.deserialize(TrainDialog_1.ScorerResponse, req.body);
