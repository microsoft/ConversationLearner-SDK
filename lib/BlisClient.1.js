...
var BlisClient = (function () {
    ...
    BlisClient.prototype.AddTrainDialog = function (traindialog) {
        var _this = this;
    ...
    BlisClient.prototype.GetTrainDialog = function (dialogId) {
        var _this = this;
        var apiPath = "app/" + this.options.appId + "/traindialog/" + dialogId;
        return new Promise(function (resolve, reject) {
            var requestData = {
                url: _this.serviceUri + apiPath,
                headers: {
    ...
    BlisClient.prototype.GetTrainDialogs = function () {
        var _this = this;
        var apiPath = "app/" + this.options.appId + "/traindialog";
        return new Promise(function (resolve, reject) {
            var requestData = {
...
//# sourceMappingURL=BlisClient.1.js.map