...
var BlisUserState = (function () {
    function BlisUserState(appId) {
        ...
        this[Consts_1.UserStates.APILOOKUP] = {};
        this[Consts_1.UserStates.CURSTEP] = null;
        this[Consts_1.UserStates.TRAINSTEPS] = [];
        this[Consts_1.UserStates.EDITCOMMAND] = null;
    }
    ...
    BlisUserState.Save = function (bot, address, userData) {
        bot.loadSession(address, function (error, session) {
            if (error) {
                ...
                session.userData.Blis[Consts_1.UserStates.APILOOKUP] = userData[Consts_1.UserStates.APILOOKUP];
                session.userData.Blis[Consts_1.UserStates.CURSTEP] = userData[Consts_1.UserStates.CURSTEP];
                session.userData.Blis[Consts_1.UserStates.TRAINSTEPS] = userData[Consts_1.UserStates.TRAINSTEPS];
                session.userData.Blis[Consts_1.UserStates.EDITCOMMAND] = userData[Consts_1.UserStates.EDITCOMMAND];
                session.save();
            }
        });
    };
