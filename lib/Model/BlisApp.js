                    ...
                    case 6:
                        ...
                        for (_a = 0, apps_1 = apps; _a < apps_1.length; _a++) {
                            ...
                            if (debug) {
                                ...
                                if (!context.state[Consts_1.UserStates.APP]) {
                                    responses.push(Utils_1.Utils.MakeHero(app.name, null, null, {
                                        "Load": CommandHandler_1.LineCommands.LOADAPP + " " + app.id,
                                        "Delete": CommandHandler_1.IntCommands.DELETEAPP + " " + app.id
                                    }));
                                }
                                else if (app.id == context.state[Consts_1.UserStates.APP]) {
                                    ...
                                    responses.push(Utils_1.Utils.MakeHero(app.name, null, null, {
                                        "Load": CommandHandler_1.LineCommands.LOADAPP + " " + app.id,
                                        "Import": CommandHandler_1.LineCommands.IMPORTAPP + " " + app.id,
                                        "Delete": CommandHandler_1.IntCommands.DELETEAPP + " " + app.id
                                    }));
                                }
                            }
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        ...
                        context.state[Consts_1.UserStates.MODEL] = null;
                        context.state[Consts_1.UserStates.SESSION] = null;
                        cb(Menu_1.Menu.AddEditApp(context, ["Done"]));
                        return [3 /*break*/, 8];
                    case 7:
                        error_3 = _a.sent();
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (appId == context.state[Consts_1.UserStates.APP]) {
                            ...
                            cb(Menu_1.Menu.AddEditApp(context, cards));
                        }
                        return [3 /*break*/, 4];
                    case 3:
                        error_4 = _a.sent();
