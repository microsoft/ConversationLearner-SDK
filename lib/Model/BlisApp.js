            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        appId = appIds_2[_i];
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.DeleteApp(context.State(Consts_1.UserStates.APP), appId)];
                    case 4:
                        text = _a.sent();
                    ...
                    case 6:
                        ...
                        context.SetState(Consts_1.UserStates.MODEL, null);
                        context.SetState(Consts_1.UserStates.SESSION, null);
