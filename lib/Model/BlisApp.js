...
var BlisApp = (function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        card = Utils_1.Utils.MakeHero("Created App", appId, null, { "Help": Help_1.Help.NEWAPP });
                        cb([card]);
                        return [3 /*break*/, 4];
                    case 3:
                        error_1 = _a.sent();
    ...
    BlisApp.GetAll = function (blisClient, address, detail, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var appIds, json, msg, responses, _i, appIds_1, appId, ajson, name_1, id, error_2, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 4:
                        ajson = _a.sent();
                        name_1 = ajson['app-name'];
                        id = ajson['model-id'];
                        if (detail) {
                            responses.push(Utils_1.Utils.MakeHero(name_1, appId, null, {
                                "Load": Consts_1.Commands.LOADAPP + " " + appId,
                                "Import": Consts_1.Commands.IMPORTAPP + " " + appId,
                                "Delete": Consts_1.IntCommands.DELETEAPP + " " + appId,
                            }));
                        }
                        else {
                            msg += name_1 + " : " + appId + "\n\n";
                        }
                        BlisDebug_1.BlisDebug.Log("App lookup: " + name_1 + " : " + appId);
                        _a.label = 5;
                    case 5:
                        _i++;
                        return [3 /*break*/, 3];
    ...
    BlisApp.Export = function (blisClient, userState, address, bot, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var dialogIds, blisapp, msg, error_5, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        dialogIds = [];
                        return [4 /*yield*/, blisClient.ExportApp(userState[Consts_1.UserStates.APP])];
                    case 2:
                        blisapp = _a.sent();
                        ...
                        if (address.channelId == "emulator") {
                            ...
                            Utils_1.Utils.SendAsAttachment(bot, address, msg);
                            cb("");
                        }
                        return [3 /*break*/, 4];
                    case 3:
    ...
    BlisApp.Import = function (blisClient, userState, address, appId, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var currentApp, mergeApp, finalApp, memory, error_6, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                    ...
                    case 1:
                        currentApp = _a.sent();
                        return [4 /*yield*/, blisClient.ExportApp(appId)];
                    case 2:
                        mergeApp = _a.sent();
                        ...
                        return [4 /*yield*/, blisClient.ImportApp(userState[Consts_1.UserStates.APP], mergeApp)];
                    case 3:
                        finalApp = _a.sent();
                        memory = new BlisMemory_1.BlisMemory(userState);
                        this.Load(blisClient, userState, address, memory.AppId(), function (text) {
                            cb(text);
                        });
                        return [3 /*break*/, 5];
                    case 4:
    ...
    BlisApp.ImportAttachment = function (blisClient, userState, address, attachment, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var text, json, blisApp, newApp, memory, error_7, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        blisApp = json_typescript_mapper_1.deserialize(BlisApp, json);
                        return [4 /*yield*/, blisClient.ImportApp(userState[Consts_1.UserStates.APP], json)];
                    case 3:
                        newApp = _a.sent();
                        memory = new BlisMemory_1.BlisMemory(userState);
                        BlisApp.Load(blisClient, userState, address, memory.AppId(), function (text) {
                            cb(text);
                        });
                        return [3 /*break*/, 5];
                    case 4:
                        error_7 = _a.sent();
                        errMsg = Utils_1.Utils.ErrorString(error_7);
                        BlisDebug_1.BlisDebug.Error(errMsg);
                        cb(text);
                        return [3 /*break*/, 5];
                    case 5: return [2 /*return*/];
    ...
    BlisApp.Load = function (blisClient, userState, address, appId, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var msg, loadedId, numActions, modelId, sessionId, error_8, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 8, , 9]);
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Entity_1.Entity.Get(blisClient, userState, null, function (text) {
                                BlisDebug_1.BlisDebug.Log("Entity lookup generated");
                            })];
                    case 2:
                        // Load entities to generate lookup table
                        _a.sent();
                        return [4 /*yield*/, Action_1.Action.Get(blisClient, userState, null, function (text) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, blisClient.GetModel(userState[Consts_1.UserStates.APP])];
                    case 4:
                        modelId = _a.sent();
                        if (!!userState[Consts_1.UserStates.MODEL]) return [3 /*break*/, 6];
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, blisClient.StartSession(userState[Consts_1.UserStates.APP])];
                    case 7:
                        sessionId = _a.sent();
                    ...
                    case 8:
                        error_8 = _a.sent();
                        errMsg = Utils_1.Utils.ErrorString(error_8);
                        BlisDebug_1.BlisDebug.Error(errMsg);
                        cb(errMsg);
                        return [3 /*break*/, 9];
    ...
    BlisApp.SwapMatches = function (ids, swapList) {
    ...
    /** Merge entites */
    BlisApp.MergeEntities = function (app1, app2) {
    ...
    /** Merge actions */
    BlisApp.MergeActions = function (app1, app2) {
...
tslib_1.__decorate([
    json_typescript_mapper_2.JsonProperty({ clazz: Action_1.Action, name: 'actions' }),
    tslib_1.__metadata("design:type", Array)
], BlisApp.prototype, "actions", void 0);
tslib_1.__decorate([
    json_typescript_mapper_2.JsonProperty({ clazz: Entity_1.Entity, name: 'entities' }),
    tslib_1.__metadata("design:type", Array)
