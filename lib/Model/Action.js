...
var Action = (function () {
    ...
    Action.Add_v1 = function (context, actionId, actionType, apiType, content, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var actionSet, _a, action, commands, error, changeType, editAction, metadata, newAction, substr, type, card, error_3, errMsg;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.EditAction(context.State(Consts_1.UserStates.APP), editAction)];
                    case 2:
                        actionId = _b.sent();
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.AddAction(context.State(Consts_1.UserStates.APP), newAction)];
                    case 4:
                        actionId = _b.sent();
    ...
    Action.Delete_v1 = function (context, actionId, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var action, inUse, card_1, card, error_4, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        BlisDebug_1.BlisDebug.Log("Trying to Delete Action");
                    ...
                    case 2:
                        action = _a.sent();
                        return [4 /*yield*/, action.InUse(context.State(Consts_1.UserStates.APP))];
                    case 3:
                        inUse = _a.sent();
                        if (inUse) {
    ...
    Action.GetAll = function (context, actionType, search, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var debug, actionIds, responses, json, textactions, apiactions, actions, memory, _i, actionIds_1, actionId, action, _a, actions_1, action, posstring, negstring, atext, postext, negtext, wait, line, type, subtext, msg, error_5, errMsg;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
