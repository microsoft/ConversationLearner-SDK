...
var Action = (function () {
    ...
    Action.Add = function (appId, action) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var action_v1, actionId;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        action_v1 = Action_v1.TOV1(action);
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.AddAction(appId, action_v1)];
                    case 1:
                        actionId = _a.sent();
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        action_v1 = Action_v1.TOV1(action);
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.EditAction(appId, action_v1)];
                    case 1:
                        actionId = _a.sent();
                        return [2 /*return*/, AdminResponse_1.AdminResponse.Result(actionId)];
                }
    ...
    Action.Delete = function (appId, actionId) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var action_v1, action, inUse, msg, error_1, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
...
var Action_v1 = (function () {
    ...
    Action_v1.prototype.Equal = function (action) {
    ...
    Action_v1.prototype.DisplayType = function () {
    ...
    Action_v1.Sort = function (actions) {
    ...
    /** Is the Activity used anywhere */
    Action_v1.prototype.InUse = function (appId) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var appContent, appString;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 5:
                        ...
                        return [3 /*break*/, 8];
                    case 6:
                        metadata = new ActionMetaData_v1({ type: apiType });
                        newAction = new Action_v1({
                            actionType: actionType,
                            content: action,
                            negativeEntities: actionSet.negIds,
                            requiredEntities: actionSet.posIds,
    ...
    Action_v1.GetAll = function (context, actionType, search, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
