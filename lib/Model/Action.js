...
var Action = (function () {
    ...
    Action.Buttons = function (id, actionType) {
        var editCommand = (actionType == Consts_1.ActionTypes.API) ? CommandHandler_1.IntCommands.EDITAPICALL : CommandHandler_1.IntCommands.EDITRESPONSE;
        var buttons = {
            "Edit": editCommand + " " + id,
            "Delete": CommandHandler_1.LineCommands.DELETEACTION + " " + id,
        };
        return buttons;
    };
    ...
    Action.Add = function (context, actionId, actionType, content, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var actionSet, _a, response, commands, error, memory, saveAPI, apiCall, metadata, apiActionId, changeType, substr, card, error_2, errMsg;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _a = content.split('//'), response = _a[0], commands = _a[1];
                        error = this.ProcessCommandString(context, actionSet, commands);
                        if (error) {
                            cb(Menu_1.Menu.AddEditApp(context, [error]), null);
                            return [2 /*return*/];
                        }
                        ...
                        if (!actionSet.saveId) return [3 /*break*/, 3];
                        memory = context.Memory();
                        saveAPI = memory.APILookup(actionSet.saveName);
                        if (!!saveAPI) return [3 /*break*/, 3];
                        apiCall = Consts_1.APICalls.SAVEENTITY + " " + actionSet.saveName;
                        metadata = new ActionMetaData({ internal: true });
                        return [4 /*yield*/, context.client.AddAction(context.state[Consts_1.UserStates.APP], apiCall, Consts_1.ActionTypes.API, [], [actionSet.saveId], null, metadata)];
                    case 2:
                        apiActionId = _b.sent();
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, context.client.EditAction(context.state[Consts_1.UserStates.APP], actionId, response, actionType, actionSet.posIds, actionSet.negIds)];
                    case 4:
                        actionId = _b.sent();
                        changeType = changeType + " Edited";
                        return [3 /*break*/, 7];
                    case 5: return [4 /*yield*/, context.client.AddAction(context.state[Consts_1.UserStates.APP], response, actionType, actionSet.posIds, actionSet.negIds, null, null)];
                    case 6:
                        actionId = _b.sent();
                    ...
                    case 6:
                        ...
                        for (_a = 0, actions_1 = actions; _a < actions_1.length; _a++) {
                            ...
                            if (debug) {
                                ...
                                responses.push(Utils_1.Utils.MakeHero(atext, typeDesc + " " + postext + negtext, null, Action.Buttons(action.id, action.actionType)));
                            }
                        }
                        if (debug) {
                            msg = "";
