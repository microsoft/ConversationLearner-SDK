...
var Action = (function () {
    ...
    Action.Add = function (context, actionId, actionType, content, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var error, commandHelp, msg, firstNeg, firstPos, cut, actionText, memory, negIds, posIds, negNames, posNames, saveName, saveId, words, _i, words_2, word, posName, posID, negName, negID, posName, posID, saveAPI, apiCall, apiActionId, changeType, substr, card, responses, error_2, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        commandHelp = actionType == Consts_1.ActionTypes.API ? Consts_1.Commands.ADDAPICALL : Consts_1.Commands.ADDRESPONSE;
                        if (error) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, context.client.AddAction(context.state[Consts_1.UserStates.APP], apiCall, Consts_1.ActionTypes.API, [], [saveId])];
                    case 2:
                        apiActionId = _a.sent();
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 7];
                    case 5: return [4 /*yield*/, context.client.AddAction(context.state[Consts_1.UserStates.APP], actionText, actionType, posIds, negIds)];
                    case 6:
                        actionId = _a.sent();
    ...
    Action.Get = function (context, actionType, search, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
                    ...
                    case 6:
                        ...
                        for (_a = 0, actions_1 = actions; _a < actions_1.length; _a++) {
                            ...
                            if (debug) {
                                ...
                                responses.push(Utils_1.Utils.MakeHero(atext, type + " Action " + postext + negtext, null, Action.Buttons(action.id)));
                            }
                        }
                        if (debug) {
                            msg = "";
