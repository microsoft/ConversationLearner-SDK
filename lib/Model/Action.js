...
var Action = (function () {
    ...
    Action.Add = function (context, actionId, actionType, content, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var firstNeg, firstPos, cut, actionText, memory, negIds, posIds, negNames, posNames, saveName, saveId, words, _i, words_2, word, posName, posID, negName, negID, posName, posID, saveAPI, apiCall, metadata, apiActionId, changeType, substr, card, responses, error_2, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!content) {
                            cb(Menu_1.Menu.EditError("You must provide action text for the action."));
                            return [2 /*return*/];
                        }
                        else if (!actionType && !actionId) {
                            cb(Menu_1.Menu.EditError("You must provide the actionType."));
                            return [2 /*return*/];
                        }
                            ...
                            if (word.startsWith(Consts_1.ActionCommand.SUBSTITUTE)) {
                                ...
                                if (posNames.indexOf(posName) < 0) {
                                    ...
                                    if (posID) {
                                        ...
                                        cb(Menu_1.Menu.EditError("Entity $" + posName + " not found."));
                                        return [2 /*return*/];
                                    }
                                }
                            }
                                ...
                                if (saveName) {
                                    cb(Menu_1.Menu.EditError("Only one entity suggestion (denoted by \"!_ENTITY_\") allowed per Action"));
                                    return [2 /*return*/];
                                }
                                if (actionType == Consts_1.ActionTypes.API) {
                                    cb(Menu_1.Menu.EditError("Suggested entities can't be added to API Actions"));
                                    return [2 /*return*/];
                                }
                                saveName = word.slice(Consts_1.ActionCommand.SUGGEST.length);
                                saveId = memory.EntityName2Id(saveName);
                                if (!saveId) {
                                    cb(Menu_1.Menu.EditError("Entity $" + saveName + " not found."));
                                    return [2 /*return*/];
                                }
                                ...
                                if (negID) {
                                    ...
                                    cb(Menu_1.Menu.EditError("Entity " + negName + " not found."));
                                    return [2 /*return*/];
                                }
                            }
    ...
    Action.Delete = function (context, actionId, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var msg, action, inUse, card_1, card, error_3, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
