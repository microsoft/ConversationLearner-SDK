...
var Action = (function () {
    ...
    Action.Add = function (context, actionId, actionType, apiType, content, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var actionSet, _a, action, commands, error, memory, saveAPI, apiCall, metadata, apiActionId, changeType, metadata, substr, type, card, error_2, errMsg;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        saveAPI = memory.SaveLookup(actionSet.saveName);
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, context.client.EditAction(context.state[Consts_1.UserStates.APP], actionId, action, actionType, actionSet.posIds, actionSet.negIds)];
                    case 4:
                        actionId = _b.sent();
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, context.client.AddAction(context.state[Consts_1.UserStates.APP], action, actionType, actionSet.posIds, actionSet.negIds, null, metadata)];
                    case 6:
                        actionId = _b.sent();
    ...
    Action.GetAll = function (context, actionType, search, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var debug, actionIds, responses, json, textactions, apiactions, actions, memory, _i, actionIds_1, actionId, action, name_1, _a, actions_1, action, posstring, negstring, atext, postext, negtext, line, type, subtext, msg, error_4, errMsg;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (debug || !action.metadata || !action.metadata.internal) {
                            if ((!search || action.content.toLowerCase().indexOf(search) > -1) && (!actionType || action.actionType == actionType)) {
                                ...
                                if (action.actionType == Consts_1.ActionTypes.API && action.content.startsWith(Consts_1.APICalls.SAVEENTITY)) {
                                    ...
                                    memory.AddSaveLookup(name_1, actionId);
                                }
