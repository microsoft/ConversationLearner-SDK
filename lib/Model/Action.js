...
var Action_1 = require("../NPM/Action");
...
var Action = (function (_super) {
    ...
    Action.GetAll = function (key, actionType, search) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var memory, appId, debug, actionIds, json, textactions, apiactions, actions, _i, actionIds_1, actionId, action, error_1, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        actionIds = [];
                        return [4 /*yield*/, BlisClient_1.BlisClient_v1.client.GetActions_v1(appId)];
                    case 3:
                        json = _a.sent();
...
//===========================================================
var ActionSet_v1 = (function () {
    function ActionSet_v1(actionType) {
...
var Action_v1 = (function () {
    ...
    Action_v1.toText = function (appId, actionId) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var action, msg, error_2;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, BlisClient_1.BlisClient_v1.client.GetAction_v1(appId, actionId)];
                    case 1:
                        action = _a.sent();
                        msg = action.content;
    ...
    Action_v1.Add_v1 = function (context, actionId, actionType, apiType, content, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var memory, appId, actionSet, _a, action, commands, error, changeType, substr, type, card, error_3, errMsg;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        actionSet = new ActionSet_v1(actionType);
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, BlisClient_1.BlisClient_v1.client.DeleteAction(appId, actionId)];
                    case 5:
                        // TODO clear savelookup
                        _a.sent();
    ...
    Action_v1.GetAll_v1 = function (context, actionType, search, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var memory, appId, debug, actionIds, responses, json, textactions, apiactions, actions, _i, actionIds_2, actionId, action, _a, actions_1, action, posstring, negstring, atext, postext, negtext, wait, line, type, subtext, msg, error_5, errMsg;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        BlisDebug_1.BlisDebug.Log("Getting actions");
