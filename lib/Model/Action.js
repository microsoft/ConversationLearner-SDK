            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        actionSet.waitAction = (actionType == Consts_1.ActionTypes.API) ? false : true;
                        ...
                        return [4 /*yield*/, context.client.EditAction(context.State(Consts_1.UserStates.APP), actionId, action, actionType, actionSet.waitAction, actionSet.posIds, actionSet.negIds)];
                    case 2:
                        actionId = _b.sent();
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, context.client.AddAction(context.State(Consts_1.UserStates.APP), action, actionType, actionSet.waitAction, actionSet.posIds, actionSet.negIds, null, metadata)];
                    case 4:
                        actionId = _b.sent();
