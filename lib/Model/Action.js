...
var Action = (function () {
    ...
    Action.Buttons = function (id) {
        var buttons = {
            "Edit": Consts_1.IntCommands.EDITACTION + " " + id,
            "Delete": Consts_1.Commands.DELETEACTION + " " + id,
        };
        return buttons;
    };
    Action.Add = function (context, actionId, actionType, content, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var firstNeg, firstPos, cut, actionText, memory, negIds, posIds, negNames, posNames, saveName, saveId, words, _i, words_2, word, posName, posID, negName, negID, posName, posID, saveAPI, apiCall, metadata, apiActionId, changeType, substr, card, error_2, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!content) {
                            cb(Menu_1.Menu.AddEditApp(context, ["You must provide action text for the action."]), null);
                            return [2 /*return*/];
                        }
                        else if (!actionType && !actionId) {
                            cb(Menu_1.Menu.AddEditApp(context, ["You must provide the actionType."]), null);
                            return [2 /*return*/];
                        }
                    ...
                    case 1:
                            ...
                            if (word.startsWith(Consts_1.ActionCommand.SUBSTITUTE)) {
                                ...
                                if (posNames.indexOf(posName) < 0) {
                                    ...
                                    if (posID) {
                                        ...
                                        cb(Menu_1.Menu.AddEditApp(context, ["Entity $" + posName + " not found."]), null);
                                        return [2 /*return*/];
                                    }
                                }
                            }
                                ...
                                if (saveName) {
                                    cb(Menu_1.Menu.AddEditApp(context, ["Only one entity suggestion (denoted by \"!_ENTITY_\") allowed per Action"]), null);
                                    return [2 /*return*/];
                                }
                                if (actionType == Consts_1.ActionTypes.API) {
                                    cb(Menu_1.Menu.AddEditApp(context, ["Suggested entities can't be added to API Actions"]), null);
                                    return [2 /*return*/];
                                }
                                saveName = word.slice(Consts_1.ActionCommand.SUGGEST.length);
                                saveId = memory.EntityName2Id(saveName);
                                if (!saveId) {
                                    cb(Menu_1.Menu.AddEditApp(context, ["Entity $" + saveName + " not found."]), null);
                                    return [2 /*return*/];
                                }
                                ...
                                if (negID) {
                                    ...
                                    cb(Menu_1.Menu.AddEditApp(context, ["Entity " + negName + " not found."]), null);
                                    return [2 /*return*/];
                                }
                            }
                        ...
                        metadata = new ActionMetaData({ internal: true });
                        return [4 /*yield*/, context.client.AddAction(context.state[Consts_1.UserStates.APP], apiCall, Consts_1.ActionTypes.API, [], [saveId], null, metadata)];
                    case 2:
                        apiActionId = _a.sent();
                        memory.AddAPILookup(saveName, apiActionId);
                        _a.label = 3;
                    case 3:
                        changeType = (actionType == Consts_1.ActionTypes.TEXT) ? "Response" : "Api Call";
                        if (!actionId) return [3 /*break*/, 5];
                        return [4 /*yield*/, context.client.EditAction(context.state[Consts_1.UserStates.APP], actionId, actionText, actionType, posIds, negIds)];
                    case 4:
                        actionId = _a.sent();
                        changeType = changeType + " Edited";
                        return [3 /*break*/, 7];
                    case 5: return [4 /*yield*/, context.client.AddAction(context.state[Consts_1.UserStates.APP], actionText, actionType, posIds, negIds, null, null)];
                    case 6:
                        actionId = _a.sent();
                    ...
                    case 7:
                        ...
                        card = Utils_1.Utils.MakeHero("" + changeType, substr + "\n\n", actionText, Action.Buttons(actionId));
                        cb(Menu_1.Menu.AddEditApp(context, [card]), actionId);
                        return [3 /*break*/, 9];
                    case 8:
                        error_2 = _a.sent();
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!actionId) {
                            cb(Menu_1.Menu.AddEditApp(context, ["You must provide the ID of the action to delete."]));
                            return [2 /*return*/];
                        }
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 5, , 6]);
                        return [4 /*yield*/, context.client.GetAction(context.state[Consts_1.UserStates.APP], actionId)];
                    case 2:
                        action = _a.sent();
                    ...
                    case 3:
                        ...
                        if (inUse) {
                            ...
                            cb(Menu_1.Menu.AddEditApp(context, [card_1]));
                            return [2 /*return*/];
                        }
                        // TODO clear savelookup
                        return [4 /*yield*/, context.client.DeleteAction(context.state[Consts_1.UserStates.APP], actionId)];
                    case 4:
                        // TODO clear savelookup
                        _a.sent();
    ...
    Action.GetAll = function (context, actionType, search, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var debug, actionIds, responses, json, textactions, apiactions, actions, memory, _i, actionIds_1, actionId, action, name_1, _a, actions_1, action, posstring, negstring, atext, postext, negtext, line, typeDesc, msg, error_4, errMsg;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        actionIds = [];
                        responses = [];
                        return [4 /*yield*/, context.client.GetActions(context.state[Consts_1.UserStates.APP])];
                    case 2:
                        json = _b.sent();
                    ...
                    case 6:
                        ...
                        for (_a = 0, actions_1 = actions; _a < actions_1.length; _a++) {
                            ...
                            if (debug) {
                                ...
                                typeDesc = (action.actionType == Consts_1.ActionTypes.API) ? "API Call" : "Response";
                                responses.push(Utils_1.Utils.MakeHero(atext, typeDesc + " " + postext + negtext, null, Action.Buttons(action.id)));
                            }
                        }
                        if (debug) {
                            msg = "";
