...
var Action = (function () {
    ...
    Action.Get = function (blisClient, userState, detail, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var actionIds, json, responses, textactions, apiactions, _i, actionIds_1, actionId, action, memory, posstring, negstring, atext, postext, negtext, name_1, msg, error_4, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 4:
                        ...
                        if (action.actionType == Consts_1.ActionTypes.API) {
                            if (detail) {
                                responses.push(Utils_1.Utils.MakeHero("API Action", postext + negtext, atext, {
                                    "Edit": Consts_1.IntCommands.EDITACTION + " " + actionId,
                                    "Delete": Consts_1.Commands.DELETEACTION + " " + actionId,
                                }));
                            }
                            else {
                            ...
                            if (detail) {
                                responses.push(Utils_1.Utils.MakeHero("TEXT Action", postext + negtext, atext, {
                                    "Edit": Consts_1.IntCommands.EDITACTION + " " + actionId,
                                    "Delete": Consts_1.Commands.DELETEACTION + " " + actionId,
                                }));
                            }
