            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        if (!(_i < commandWords_1.length)) return [3 /*break*/, 11];
                        ...
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, memory.EntityName2Id(negName)];
                    case 3:
                        negID = _a.sent();
                        if (negID) {
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, memory.EntityName2Id(posName)];
                    case 7:
                        posID = _a.sent();
                        if (posID) {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        if (!(_i < words_2.length)) return [3 /*break*/, 6];
                        word = words_2[_i];
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 8:
                        ...
                        action = actions_1[_a];
                        return [4 /*yield*/, memory.EntityIds2Names(action.requiredEntities)];
                    case 9:
                        posstring = _b.sent();
                        return [4 /*yield*/, memory.EntityIds2Names(action.negativeEntities)];
                    case 10:
                        negstring = _b.sent();
