...
var TrainSteps = (function (_super) {
    tslib_1.__extends(TrainSteps, _super);
    function TrainSteps(init) {
        var _this = _super.call(this) || this;
        _this.steps = [];
        _this.steps = undefined;
        Object.assign(_this, init);
        return _this;
    }
    return TrainSteps;
...
tslib_1.__decorate([
    json_typescript_mapper_1.JsonProperty('steps'),
    tslib_1.__metadata("design:type", Array)
], TrainSteps.prototype, "steps", void 0);
exports.TrainSteps = TrainSteps;
