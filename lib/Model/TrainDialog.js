                        ...
                        for (i in dialogs) {
                            ...
                            if (cur == index) {
                                ...
                                if (cur == 0) {
                                    buttons =
                                        {
                                            "Next": CommandHandler_1.IntCommands.TRAINDIALOG_NEXT,
                                            "Done": CommandHandler_1.IntCommands.EDITAPP,
                                            "Delete": CommandHandler_1.IntCommands.DELETEDIALOG + " " + dialog.dialogId,
                                        };
                                }
                                else if (cur == dialogs.length - 1) {
                                    buttons =
                                        {
                                            "Prev": CommandHandler_1.IntCommands.TRAINDIALOG_PREV,
                                            "Done": CommandHandler_1.IntCommands.EDITAPP,
                                            "Delete": CommandHandler_1.IntCommands.DELETEDIALOG + " " + dialog.dialogId,
                                        };
                                }
