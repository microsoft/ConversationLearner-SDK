...
var Dialog = (function () {
    ...
    Dialog.prototype.toText = function (client, appId, number) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
...
var TrainDialog = (function () {
    ...
    TrainDialog.prototype.toText = function (client, appId, number) {
        if (number === void 0) { number = false; }
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var dialogText;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.dialog.toText(client, appId, number)];
                    case 1:
                        dialogText = _a.sent();
    ...
    TrainDialog.Edit = function (context, dialogId, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var appId, trainDialog, text, altTexts, altText;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        appId = context.State(Consts_1.UserStates.APP);
                        return [4 /*yield*/, context.client.GetTrainDialog(appId, dialogId)];
                    case 1:
                        trainDialog = _a.sent();
                        return [4 /*yield*/, trainDialog.toText(context.client, appId, true)];
                    case 2:
                        text = _a.sent();
                        cb([text]);
                        altTexts = [];
                        altText = new AltText({ text: "hmmmm" });
                        ...
                        return [4 /*yield*/, context.client.EditTrainDialog(context.State(Consts_1.UserStates.APP), dialogId, trainDialog)];
                    case 3:
                        //trainDialog.dialog.turns[0].input.text = "LETS TRY THIS";
                        _a.sent();
                        return [2 /*return*/];
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        blisApp = _a.sent();
                        return [4 /*yield*/, blisApp.FindTrainDialogs(context.client, appId, Pager_1.Pager.SearchTerm(context.session))];
                    case 2:
                        dialogs = _a.sent();
                        if (dialogs.length == 0) {
