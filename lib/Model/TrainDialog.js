...
var ScorerInput = (function () {
    function ScorerInput(init) {
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Array)
], ScorerInput.prototype, "filledEntities", void 0);
tslib_1.__decorate([
    json_typescript_mapper_1.JsonProperty('context'),
    tslib_1.__metadata("design:type", String)
], ScorerInput.prototype, "context", void 0);
tslib_1.__decorate([
    json_typescript_mapper_1.JsonProperty('maskedActions'),
    tslib_1.__metadata("design:type", Array)
], ScorerInput.prototype, "maskedActions", void 0);
exports.ScorerInput = ScorerInput;
var ScorerResponse = (function () {
    function ScorerResponse(init) {
...
tslib_1.__decorate([
    json_typescript_mapper_1.JsonProperty({ clazz: ScorerInput, name: 'input' }),
    tslib_1.__metadata("design:type", ScorerInput)
], ScorerResponse.prototype, "input", void 0);
tslib_1.__decorate([
    json_typescript_mapper_1.JsonProperty('labelAction'),
    tslib_1.__metadata("design:type", String)
], ScorerResponse.prototype, "labelAction", void 0);
exports.ScorerResponse = ScorerResponse;
var Round = (function () {
    function Round(init) {
...
tslib_1.__decorate([
    json_typescript_mapper_1.JsonProperty({ clazz: ExtractorStep, name: 'extractorStep' }),
    tslib_1.__metadata("design:type", ExtractorStep)
], Round.prototype, "extractorStep", void 0);
tslib_1.__decorate([
    json_typescript_mapper_1.JsonProperty({ clazz: ScorerResponse, name: 'scorerSteps' }),
    tslib_1.__metadata("design:type", Array)
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 8];
                    case 4: return [4 /*yield*/, BlisClient_1.BlisClient_v1.client.GetTrainDialog(appId, dialogId)];
                    case 5:
                        trainDialog = _b.sent();
                    ...
                    case 6:
                        ...
                        // Save
                        return [4 /*yield*/, BlisClient_1.BlisClient_v1.client.EditTrainDialog(appId, dialogId, trainDialog)];
                    case 7:
                        // Save
                        _b.sent();
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        appId = _a.sent();
                        return [4 /*yield*/, BlisClient_1.BlisClient_v1.client.DeleteTrainDialog(appId, dialogId)];
                    case 3:
                        _a.sent();
            ...
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        appId = _d.sent();
                        if (refreshCache) {
                            BlisClient_1.BlisClient_v1.client.ClearExportCache(appId);
                        }
                        return [4 /*yield*/, BlisClient_1.BlisClient_v1.client.ExportApp(appId)];
                    case 2:
                        blisApp = _d.sent();
