...
var TrainDialog = (function () {
    ...
    TrainDialog.Delete = function (blisClient, userState, dialogId, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, blisClient.DeleteTrainDialog(userState[Consts_1.UserStates.APP], dialogId)];
                    case 2:
                        // TODO clear savelookup
                        _a.sent();
    ...
    TrainDialog.Get = function (blisClient, userState, address, searchTerm, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        blisApp = _a.sent();
                        return [4 /*yield*/, blisApp.FindTrainDialogs(blisClient, userState[Consts_1.UserStates.APP], searchTerm)];
                    case 2:
                        dialogs = _a.sent();
                        if (dialogs.length == 0) {
