    ...
    BlisHelp.CommandHelp = function (name) {
        ...
        switch (name) {
            ...
            case Consts_1.Commands.DELETEENTITY:
                return new Command_1.Command(name, "Delete an entity on current app", "{_entityId_}", null);
            ...
            case Consts_1.Commands.EDITACTION:
                return new Command_1.Command(name, "Edit an action on current app", "{_actionId_} {_Action Text_} --{Entity that blocks action} ++{Entity required for action}", null);
            case Consts_1.Commands.EDITENTITY:
                return new Command_1.Command(name, "Edit an entity on current app", "{_entityId_} {_entitiyName_} {_LUIS | LOCAL_} {_prebuildName?_}", null);
