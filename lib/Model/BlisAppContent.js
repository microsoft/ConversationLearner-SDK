...
var BlisAppContent = (function () {
    ...
    BlisAppContent.Export = function (blisClient, userState, address, bot, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
    ...
    BlisAppContent.Import = function (blisClient, userState, address, appId, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
    ...
    BlisAppContent.ImportAttachment = function (blisClient, userState, address, attachment, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        newApp = _a.sent();
                        memory = new BlisMemory_1.BlisMemory(userState);
                        BlisAppContent.Load(blisClient, userState, address, memory.AppId(), function (text) {
                            cb(text);
                        });
                        return [3 /*break*/, 5];
                    case 4:
    ...
    BlisAppContent.Load = function (blisClient, userState, address, appId, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
