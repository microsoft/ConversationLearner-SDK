...
var BlisAppContent = (function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        dialogIds = [];
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.ExportApp(context.State(Consts_1.UserStates.APP))];
                    case 2:
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.ImportApp(context.State(Consts_1.UserStates.APP), mergeApp)];
                    case 3:
                        finalApp = _a.sent();
    ...
    BlisAppContent.ImportAttachment = function (context, attachment, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var text, json, blisApp, newApp, memory, error_3, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.ImportApp(context.State(Consts_1.UserStates.APP), blisApp)
                            // Reload the app
                        ];
                    case 3:
                        newApp = _a.sent();
    ...
    BlisAppContent.Load = function (context, appId, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var app, error_4, numActions, modelId, error_5, errMsg, error_6, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        app = _a.sent();
                        context.SetState(Consts_1.UserStates.APP, app.id);
                        BlisDebug_1.BlisDebug.Log("Loaded App: " + app.id);
                        return [3 /*break*/, 4];
                    case 3:
                        error_4 = _a.sent();
                        // Bad App
                        context.SetState(Consts_1.UserStates.APP, null);
                        throw error_4;
                    case 4: 
                    ...
                    case 7:
                        ...
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.GetModel(context.State(Consts_1.UserStates.APP))];
                    case 8:
                        // Load or train a new modelId
                        modelId = _a.sent();
                        if (!!modelId) return [3 /*break*/, 10];
                    ...
                    case 11:
                        ...
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.TrainModel(context.State(Consts_1.UserStates.APP), true)];
                    case 12:
                        modelId = _a.sent();
                        context.SetState(Consts_1.UserStates.MODEL, modelId);
                        BlisDebug_1.BlisDebug.Log("Model trained: " + modelId);
