            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, context.client.ImportApp(context.State(Consts_1.UserStates.APP), blisApp)
                            // Reload the app
                        ];
                    case 3:
                        newApp = _a.sent();
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 8:
                        ...
                        return [4 /*yield*/, context.client.TrainModel(context.State(Consts_1.UserStates.APP))];
                    case 9:
                        modelId = _a.sent();
                    ...
                    case 11:
                        ...
                        return [4 /*yield*/, context.client.TrainModel(context.State(Consts_1.UserStates.APP), true)];
                    case 12:
                        modelId = _a.sent();
                        context.SetState(Consts_1.UserStates.MODEL, modelId);
                        BlisDebug_1.BlisDebug.Log("Model trained: " + modelId);
