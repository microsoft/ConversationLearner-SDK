        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        curAppId = _a.sent();
                        return [4 /*yield*/, BlisClient_1.BlisClient_v1.client.ExportApp(curAppId)];
                    case 2:
                        currentApp = _a.sent();
                        return [4 /*yield*/, BlisClient_1.BlisClient_v1.client.ExportApp(appId)];
                    case 3:
                        ...
                        return [4 /*yield*/, BlisClient_1.BlisClient_v1.client.ImportApp(curAppId, mergeApp)];
                    case 4:
                        finalApp = _a.sent();
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        appId = _a.sent();
                        return [4 /*yield*/, BlisClient_1.BlisClient_v1.client.ImportApp(appId, blisApp)
                            // Reload the app
                        ];
                    case 4:
                        newApp = _a.sent();
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 4, , 6]);
                        return [4 /*yield*/, BlisClient_1.BlisClient_v1.client.GetApp_v1(appId)];
                    case 2:
                        app = _a.sent();
                    ...
                    case 14:
                        ...
                        return [4 /*yield*/, BlisClient_1.BlisClient_v1.client.TrainModel(appId, true)];
                    case 15:
                        modelId = _a.sent();
                        return [4 /*yield*/, memory.BotState().SetModelId(modelId)];
                    case 16:
...
tslib_1.__decorate([
    json_typescript_mapper_2.JsonProperty({ clazz: TrainDialog_1.TrainDialog_v1, name: 'traindialogs' }),
    tslib_1.__metadata("design:type", Array)
