...
var Entity = (function () {
    ...
    Entity.Add = function (context, entityId, entityType, userInput, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.EditEntity(context.State(Consts_1.UserStates.APP), entityId, content, null, prebuiltName, metadata)];
                    case 3:
                        _b.sent();
                        ...
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.EditEntity(context.State(Consts_1.UserStates.APP), oldNegId, negName, null, prebuiltName, negmeta)];
                    case 4:
                        _b.sent();
                    ...
                    case 9:
                        ...
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.AddEntity(context.State(Consts_1.UserStates.APP), negName, entityType, prebuiltName, negmeta)];
                    case 10:
                        newNegId = _b.sent();
                    ...
                    case 15:
                        metadata = new EntityMetaData({ bucket: isBucket, task: taskId });
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.AddEntity(context.State(Consts_1.UserStates.APP), content, entityType, prebuiltName, metadata)];
                    case 16:
                        entityId = _b.sent();
                        memory.AddEntityLookup(content, entityId);
                    ...
                    case 18:
                        ...
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.EditEntity(context.State(Consts_1.UserStates.APP), entityId, content, null, prebuiltName, metadata_1)];
                    case 19:
                        _b.sent();
