            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.GetEntity(appId, entity.entityId, null)];
                    case 3:
                        oldEntity = _b.sent();
                    ...
                    case 6:
                        _b.sent();
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.GetEntity(appId, oldNegId, null)];
                    case 7:
                        oldEntity_1 = _b.sent();
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        appId_1 = _a.sent();
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.GetEntity(appId_1, entityId, null)];
                    case 3:
                        entity = _a.sent();
