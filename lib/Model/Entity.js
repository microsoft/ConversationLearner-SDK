...
var Entity_1 = require("../NPM/Entity");
...
var Entity = (function (_super) {
    ...
    Entity.Get = function (key, search) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var memory, appId, debug, entityIds, json, entities, _i, entityIds_1, entityId, entity, error_1, errMsg;
...
var Entity_v1 = (function () {
    ...
    Entity_v1.prototype.TOV2 = function () {
        var metadataV2 = new Entity_1.EntityMetaData();
    ...
    Entity_v1.Add_v1 = function (context, entityId, entityType, userInput, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var memory, appId, isBucket, isNegatable, _a, content, task, regex, taskId, prebuiltName, responses, changeType, negName, oldEntity, oldNegName, oldNegId, metadata, negmeta, metadata, negmeta, newNegId, metadata, metadata, metadata, negmeta, newNegId, metadata_1, error_3, errMsg, modelId, error_4;
    ...
    Entity_v1.Delete_v1 = function (context, entityId, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var msg, responses, memory, appId, entity, inUse, card, negEntity, error_5, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    Entity_v1.Get_v1 = function (context, search, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var memory, appId, debug, entityIds, json, msg, responses, entities, _i, entityIds_2, entityId, entity, _a, entities_1, entity, desc, error_6, errMsg;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        BlisDebug_1.BlisDebug.Log("Getting entities");
