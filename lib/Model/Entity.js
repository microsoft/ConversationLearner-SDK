...
var Entity_v1 = (function () {
    ...
    Entity_v1.NegativeName = function (name) {
        return Consts_1.ActionCommand.NEGATIVE + name;
    };
    /** Return negative entity if it exists */
    Entity_v1.prototype.GetNegativeEntity = function (appId, context) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    Entity_v1.prototype.InUse = function (appId, context) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
    ...
    Entity_v1.prototype.Description = function () {
        return Entity_v1.Description(this.entityType, this.luisPreName, this.metadata);
    };
    Entity_v1.Description = function (type, prebuilt, metadata) {
    ...
    Entity_v1.Add = function (appId, entity) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        responses = [];
                        changeType = "";
                        negName = Entity_v1.NegativeName(content);
                        if (!entityId) return [3 /*break*/, 26];
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.GetEntity(appId, entityId)];
                    case 5:
                        oldEntity = _b.sent();
                        oldNegName = Entity_v1.NegativeName(oldEntity.name);
                        // Note: Entity Type cannot be changed.  Use old type.
                        entityType = oldEntity.entityType;
    ...
    Entity_v1.Delete = function (context, entityId, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
