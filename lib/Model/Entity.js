            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.DeleteEntity(appId_1, entityId)];
                    case 5:
                        _a.sent();
                    ...
                    case 7:
                        negEntity = _a.sent();
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.DeleteEntity(appId_1, entity.metadata.negativeId)];
                    case 8:
                        _a.sent();
...
var Entity_v1 = (function () {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.GetEntity_v1(appId, entityId)];
                    case 1:
                        entity = _a.sent();
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.GetEntity_v1(appId, this.metadata.negative)];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2: return [2 /*return*/, null];
                }
            });
    ...
    Entity_v1.Sort = function (entities) {
    ...
    Entity_v1.Add_v1 = function (context, entityId, entityType, userInput, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var memory, appId, isBucket, isNegatable, _a, content, task, regex, taskId, prebuiltName, responses, changeType, negName, oldEntity, oldNegName, oldNegId, metadata, negmeta, metadata, negmeta, newNegId, metadata, metadata, metadata, negmeta, newNegId, metadata_1, error_4, errMsg, modelId, error_5;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    Entity_v1.Delete_v1 = function (context, entityId, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var msg, responses, memory, appId, entity, inUse, card, negEntity, error_6, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        BlisDebug_1.BlisDebug.Log("Trying to Delete Entity");
    ...
    /** Get all actions **/
    Entity_v1.Get = function (context, search, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var memory, appId, debug, entityIds, json, msg, responses, entities, _i, entityIds_1, entityId, entity, _a, entities_1, entity, desc, error_7, errMsg;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
