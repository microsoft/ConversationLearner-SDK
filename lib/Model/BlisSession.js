                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        if (teach) {
                            ...
                            subtext = "At any point type \"" + CommandHandler_1.LineCommands.ABANDON + "\" to abort";
                            card = Utils_1.Utils.MakeHero("Teach mode started", subtext, body, {
                                "Cancel": CommandHandler_1.LineCommands.ABANDON
                            });
                            cb([card]);
                        }
                        else {
                            card = Utils_1.Utils.MakeHero("Bot Started", null, 'Type !done at any time to stop', {
                                "Cancel": CommandHandler_1.LineCommands.DONE
                            });
                            cb([card]);
                        }
                        return [3 /*break*/, 5];
