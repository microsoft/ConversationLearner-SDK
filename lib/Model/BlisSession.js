...
var BlisSession = (function () {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.EndSession(context.State(Consts_1.UserStates.APP), context.State(Consts_1.UserStates.SESSION))];
                    case 1:
                        sessionId = _a.sent();
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.GetModel(context.State(Consts_1.UserStates.APP))];
                    case 2:
                        modelId = _a.sent();
                        new BlisMemory_1.BlisMemory(context.session).EndSession();
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.StartSession(context.State(Consts_1.UserStates.APP), teach)];
                    case 3:
                        sessionId = _a.sent();
                        new BlisMemory_1.BlisMemory(context.session).StartSession(sessionId, teach);
                    ...
                    case 4:
                        ...
                        context.SetState(Consts_1.UserStates.SESSION, null); // Clear the bad session
                        cb([errMsg]);
                        return [3 /*break*/, 5];
    ...
    BlisSession.TrainStepText = function (context) {
        ...
        for (var _i = 0, trainSteps_1 = trainSteps; _i < trainSteps_1.length; _i++) {
            ...
            for (var _c = 0, _d = trainstep.response; _c < _d.length; _c++) {
                var response = _d[_c];
                msg += "     " + response + "\n\n";
            }
        }
