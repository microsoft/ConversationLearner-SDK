...
var BlisApp_2 = require("./Model/BlisApp");
...
var BlisClient = (function () {
    ...
    BlisClient.prototype.AddEntity_v1 = function (appId, entityName, entityType, prebuiltEntityName, metaData) {
        var _this = this;
        var apiPath = "app/" + appId + "/entity";
        return new Promise(function (resolve, reject) {
            var requestData = {
    ...
    BlisClient.prototype.CreateApp_v1 = function (name, luisKey) {
        var _this = this;
        var apiPath = "app";
        return new Promise(function (resolve, reject) {
            var requestData = {
    ...
    BlisClient.prototype.EditAction_v1 = function (appId, actionId, content, actionType, sequenceTerminal, requiredEntityList, negativeEntityList, prebuiltEntityName) {
        var _this = this;
    ...
    BlisClient.prototype.EditEntity_v1 = function (appId, entityId, entityName, entityType, prebuiltEntityName, metaData) {
        var _this = this;
        var apiPath = "app/" + appId + "/entity/" + entityId;
        // Clear old one from cache
    ...
    BlisClient.prototype.EditTrainDialog = function (appId, dialogId, trainDialog) {
        var _this = this;
        var apiPath = "app/" + appId + "/traindialog/" + dialogId;
        return new Promise(function (resolve, reject) {
            var requestData = {
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.get(url, requestData, function (error, response, body) {
                if (error) {
                    ...
                    var blisApp = json_typescript_mapper_1.deserialize(BlisApp_2.BlisApp, body);
                    blisApp.appId = appId;
                    resolve(blisApp);
                }
            });
    ...
    BlisClient.prototype.GetApp_v1 = function (appId) {
        var _this = this;
        var apiPath = "app/" + appId;
        return new Promise(function (resolve, reject) {
            var url = _this.serviceUri + apiPath;
    ...
    BlisClient.prototype.GetAction_v1 = function (appId, actionId) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            // Check cache first
            var action = _this.actionCache.get(actionId);
    ...
    BlisClient.prototype.GetEntity_v1 = function (appId, entityId) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            // Check cache first
            var entity = _this.entityCache.get(entityId);
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.get(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var dialog = json_typescript_mapper_1.deserialize(TrainDialog_1.Dialog, body);
                    var trainDialog = new TrainDialog_1.TrainDialog({ dialog: dialog, id: dialogId });
                    resolve(trainDialog);
                }
            });
        });
