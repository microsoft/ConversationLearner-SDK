...
var BlisClient = (function () {
    ...
    BlisClient.prototype.MakeURL = function (apiPath, query) {
        var uri = this.serviceUri + apiPath;
        if (query)
            uri += "?" + query;
        return uri;
    };
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.get(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var action = json_typescript_mapper_1.deserialize(blis_models_1.ActionBase, body);
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.get(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var actions = json_typescript_mapper_1.deserialize(blis_models_1.ActionList, body);
                    resolve(actions);
                }
            });
        });
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.get(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var actions = json_typescript_mapper_1.deserialize(blis_models_1.ActionIdList, body);
                    resolve(actions);
                }
            });
        });
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.get(url, requestData, function (error, response, body) {
                if (error) {
                    ...
                    var blisApp = json_typescript_mapper_1.deserialize(blis_models_1.BlisAppBase, body);
                    blisApp.appId = appId;
                    resolve(blisApp);
                }
            });
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.get(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var apps = json_typescript_mapper_1.deserialize(blis_models_1.BlisAppList, body);
                    resolve(apps);
                }
            });
        });
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.get(url, requestData, function (error, response, body) {
                if (error) {
                    ...
                    var app = json_typescript_mapper_1.deserialize(blis_models_1.BlisAppBase, body);
                    resolve(app);
                }
            });
        });
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.get(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var apps = json_typescript_mapper_1.deserialize(blis_models_1.BlisAppIdList, body);
                    resolve(apps);
                }
            });
        });
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.get(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var entity_1 = json_typescript_mapper_1.deserialize(blis_models_1.EntityBase, body);
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.get(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var entities = json_typescript_mapper_1.deserialize(blis_models_1.EntityList, body);
                    resolve(entities);
                }
            });
        });
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.get(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var entityIds = json_typescript_mapper_1.deserialize(blis_models_1.EntityIdList, body);
                    resolve(entityIds);
                }
            });
        });
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.get(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var logDialog = json_typescript_mapper_1.deserialize(blis_models_1.LogDialog, body);
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.get(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var logDialogList = json_typescript_mapper_1.deserialize(blis_models_1.LogDialogList, body);
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.get(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var logDialogsIds = json_typescript_mapper_1.deserialize(blis_models_1.LogDialogIdList, body);
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.post(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var editResponse = json_typescript_mapper_1.deserialize(blis_models_1.TrainResponse, body);
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.get(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var trainDialog = json_typescript_mapper_1.deserialize(blis_models_1.TrainDialog, body);
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.get(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var trainDialogList = json_typescript_mapper_1.deserialize(blis_models_1.TrainDialogList, body);
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.get(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var trainDialogsIds = json_typescript_mapper_1.deserialize(blis_models_1.TrainDialogIdList, body);
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.delete(url, requestData, function (error, response, body) {
                if (error) {
                    ...
                    var deleteResponse = json_typescript_mapper_1.deserialize(blis_models_1.TrainResponse, body);
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.post(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var session = json_typescript_mapper_1.deserialize(blis_models_1.Session, body);
                    resolve(session);
                }
            });
        });
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.put(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var extractResponse = json_typescript_mapper_1.deserialize(blis_models_1.ExtractResponse, body);
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.put(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var score = json_typescript_mapper_1.deserialize(blis_models_1.ScoreResponse, body);
                    resolve(score);
                }
            });
        });
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.get(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var sessions = json_typescript_mapper_1.deserialize(blis_models_1.SessionList, body);
                    resolve(sessions);
                }
            });
        });
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.get(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var sessionIds = json_typescript_mapper_1.deserialize(blis_models_1.SessionIdList, body);
                    resolve(sessionIds);
                }
            });
        });
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.post(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var teachResponse = json_typescript_mapper_1.deserialize(blis_models_1.TeachResponse, body);
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.get(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var teach = json_typescript_mapper_1.deserialize(blis_models_1.Teach, body);
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.put(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var scoreResponse = json_typescript_mapper_1.deserialize(blis_models_1.ScoreResponse, body);
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.delete(url, requestData, function (error, response, body) {
                if (error) {
                    ...
                    var trainResponse = json_typescript_mapper_1.deserialize(blis_models_1.TrainResponse, body);
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.get(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var teaches = json_typescript_mapper_1.deserialize(blis_models_1.TeachList, body);
                    resolve(teaches);
                }
            });
        });
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.get(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var teachIds = json_typescript_mapper_1.deserialize(blis_models_1.TeachIdList, body);
                    resolve(teachIds);
                }
            });
        });
