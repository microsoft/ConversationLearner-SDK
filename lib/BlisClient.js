...
var Action_2 = require("./NPM/Action");
var TrainDialog_1 = require("./Model/TrainDialog");
var TrainDialog_2 = require("./NPM/TrainDialog");
var LogDialog_1 = require("./NPM/LogDialog");
var BlisApp_1 = require("./Model/BlisApp");
var BlisApp_2 = require("./NPM/BlisApp");
var BlisAppContent_1 = require("./Model/BlisAppContent");
var Entity_1 = require("./Model/Entity");
var Entity_2 = require("./NPM/Entity");
var Teach_1 = require("./NPM/Teach");
var Score_1 = require("./NPM/Score");
var Extract_1 = require("./NPM/Extract");
var Session_1 = require("./NPM/Session");
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.get(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var actions = json_typescript_mapper_1.deserialize(Action_2.ActionList, body);
                    resolve(actions);
                }
            });
        });
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.get(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var actions = json_typescript_mapper_1.deserialize(Action_2.ActionIdList, body);
                    resolve(actions);
                }
            });
        });
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.get(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var apps = json_typescript_mapper_1.deserialize(BlisApp_2.BlisAppList, body);
                    resolve(apps);
                }
            });
        });
            ...
            request.get(requestData, function (error, response, body) {
                if (error) {
                    ...
                    if (!entity_1.metadata) {
                        entity_1.metadata = new Entity_2.EntityMetaData();
                    }
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.get(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var entities = json_typescript_mapper_1.deserialize(Entity_2.EntityList, body);
                    resolve(entities);
                }
            });
        });
        ...
        return new Promise(function (resolve, reject) {
            ...
            request.get(requestData, function (error, response, body) {
                if (error) {
                    ...
                    var entityIds = json_typescript_mapper_1.deserialize(Entity_2.EntityIdList, body);
                    resolve(entityIds);
                }
            });
        });
