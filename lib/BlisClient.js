...
var BlisClient = (function () {
    ...
    // Create singleton
    BlisClient.InitClient = function (serviceUri, user, secret, azureFunctionsUrl, azureFunctionsKey) {
    ...
    BlisClient.prototype.EditAction = function (appId, action) {
        var _this = this;
        var apiPath = "app/" + appId + "/action/" + action.id;
    ...
    BlisClient.prototype.EditEntity = function (appId, entity) {
        var _this = this;
        var apiPath = "app/" + appId + "/entity/" + entity.id;
        // Clear old one from cache
