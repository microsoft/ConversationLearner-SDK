...
var BlisClient = (function () {
    ...
    BlisClient.prototype.AddAction = function (appId, content, actionType, requiredEntityList, negativeEntityList, prebuiltEntityName, metaData) {
        var _this = this;
    ...
    BlisClient.prototype.EditAction = function (appId, actionId, content, actionType, requiredEntityList, negativeEntityList, prebuiltEntityName) {
        var _this = this;
        if (requiredEntityList === void 0) { requiredEntityList = []; }
        if (negativeEntityList === void 0) { negativeEntityList = []; }
