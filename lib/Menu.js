...
var Menu = (function () {
    ...
    Menu.AddEditCards = function (context, responses) {
        ...
        var inTeach = memory.BotState().InTeach();
    ...
    Menu.EditCards = function (newLine) {
        ...
        cards.push(Utils_1.Utils.MakeHero("Responses", null, null, {
            ...
            "Add": Command_1.IntCommands.CHOOSERESPONSETYPE
        }));
    ...
    Menu.ChooseResponse = function (session) {
        var card = Utils_1.Utils.MakeEditableHero(session, "Add Response", null, "Text or Intent?", {
            "Text": Command_1.CueCommands.ADDRESPONSETEXT,
            "Intent": Command_1.CueCommands.ADDRESPONSEINTENT,
    ...
    Menu.AddResponseText = function () {
        var card = Utils_1.Utils.MakeHero("Add Response", null, "Enter new Response", {
            "Help": Command_1.HelpCommands.ADDRESPONSETEXT,
            "Cancel": Command_1.IntCommands.CANCEL
        });
        return card;
    };
    Menu.AddResponseIntent = function () {
        var card = Utils_1.Utils.MakeHero("Add Intent", '{intent name} {args}', "Enter Intent name and args", {
            "Help": Command_1.HelpCommands.ADDRESPONSEINTENT,
            "Cancel": Command_1.IntCommands.CANCEL
        });
        return card;
    };
