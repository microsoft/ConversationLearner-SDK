...
var BlisRecognizer = (function () {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                try {
                    ...
                    BlisClient_1.BlisClient.InitClient(options.serviceUri, options.user, options.secret, options.azureFunctionsUrl, options.azureFunctionsKey);
                    ...
                    this.bot.dialog(Consts_1.BLIS_INTENT_WRAPPER, [
                        function (session, wrappedIntent) {
                            session.beginDialog(wrappedIntent.intent, wrappedIntent.entities);
                        },
                        function (session) {
                            var card = Utils_1.Utils.MakeHero(null, null, "Type next user input for this Dialog or", { "Dialog Complete": Command_1.IntCommands.DONETEACH });
    ...
    BlisRecognizer.prototype.LoadUser = function (session, cb) {
        ...
        var context = new BlisContext_1.BlisContext(this.bot, session);
        cb(null, context);
    };
    /** Send result to user */
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, memory.InTeachAsync()];
                    case 1:
                        inTeach = _a.sent();
                    ...
                    case 2:
                        appId = _a.sent();
                        return [4 /*yield*/, memory.SessionId()];
                    case 3:
                        sessionId = _a.sent();
                        if (teachAction == Consts_1.TeachAction.RETRAIN) {
                            ...
                            // Retrain the model
                            BlisClient_1.BlisClient.client.Retrain(appId, sessionId)
                                .then(function (takeTurnResponse) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                return tslib_1.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: 
                                        // Continue teach session
                                        return [4 /*yield*/, this.TakeTurnCallback(recsess, takeTurnResponse)];
                                        case 1:
                                            // Continue teach session
                                            _a.sent();
                                            return [2 /*return*/];
                                ...
                                return tslib_1.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, this.TakeTurn(recsess, recsess.userInput, actionData)];
                                        case 1:
                                            _a.sent();
                                            return [2 /*return*/];
                                    }
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.ProcessResult(recsess, responses_1, null, null)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                    case 2:
                        ...
                        return [4 /*yield*/, this.ProcessLabelEntity(recsess, ttResponse, responses)];
                    case 3:
                        _a.sent();
                        return [3 /*break*/, 7];
                    case 4:
                        if (!(ttResponse.teachStep == Consts_1.TeachStep.LABELACTION)) return [3 /*break*/, 6];
                        return [4 /*yield*/, this.ProcessLabelAction(recsess, ttResponse, responses)];
                    case 5:
                        _a.sent();
                        return [3 /*break*/, 7];
                    case 6:
                    ...
                    case 8:
                        ...
                        return [4 /*yield*/, memory.SetLastStep(Consts_1.SaveStep.RESPONSES, output)];
                    case 9:
                        _a.sent();
                    ...
                    case 11:
                        outText = _a.sent();
                        return [3 /*break*/, 14];
                    case 12: return [4 /*yield*/, this.PromisifyBC(this.DefaultBlisCallback, output, memory)];
                    case 13:
                        outText = _a.sent();
                        _a.label = 14;
                    case 14:
                        if (!inTeach) return [3 /*break*/, 16];
                        return [4 /*yield*/, memory.SetTrainStep(Consts_1.SaveStep.RESPONSES, outText)];
                    case 15:
                        _a.sent();
                    ...
                    case 19:
                        ...
                        return [4 /*yield*/, this.ProcessResult(recsess, responses, null, null)];
                    case 20:
                        _a.sent();
                        _a.label = 21;
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [3 /*break*/, 4];
                    case 1: return [4 /*yield*/, memory.SetTrainStep(Consts_1.SaveStep.INPUT, recsess.userInput)];
                    case 2:
                        _c.sent();
                        return [4 /*yield*/, memory.SetLastStep(Consts_1.SaveStep.INPUT, recsess.userInput)];
                    case 3:
                        _c.sent();
                        _c.label = 4;
                    case 4:
                        ...
                        return [4 /*yield*/, memory.LastStep(Consts_1.SaveStep.RESPONSES)];
                    case 5:
                        lastResponses = _c.sent();
                        suggestedEntity = Action_1.Action.GetEntitySuggestion(lastResponses);
                        if (suggestedEntity) {
                    ...
                    case 7:
                        ...
                        return [4 /*yield*/, memory.EntityId2Name(labelEntity.id)];
                    case 8:
                        entityName = _c.sent();
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        BlisDebug_1.BlisDebug.Verbose("ProcessLabelEntity");
                        memory = recsess.context.Memory();
                        return [4 /*yield*/, memory.TrainStepInput()];
                    case 1:
                        input = _a.sent();
                        if (!!input) return [3 /*break*/, 4];
                        // Only run if no suggested entity is found
                        return [4 /*yield*/, memory.SetTrainStep(Consts_1.SaveStep.INPUT, recsess.userInput)];
                    case 2:
                        // Only run if no suggested entity is found
                        _a.sent();
                        return [4 /*yield*/, memory.SetLastStep(Consts_1.SaveStep.INPUT, recsess.userInput)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4: return [4 /*yield*/, memory.DumpEntities()];
                    case 5:
                        ents = _a.sent();
                        return [4 /*yield*/, memory.SetTrainStep(Consts_1.SaveStep.ENTITY, ents)];
                    case 6:
                        _a.sent();
                        ...
                        return [4 /*yield*/, memory.SetLastStep(Consts_1.SaveStep.CHOICES, choices)];
                    case 7:
                        // Remember valid choices
                        _a.sent();
                        _a.label = 8;
    ...
    BlisRecognizer.prototype.invoke = function (session, recCb) {
        ...
        try {
            ...
            this.LoadUser(session, function (responses, context) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                var _this = this;
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            ...
                            Utils_1.Utils.SendTyping(this.bot, address_1);
                            ...
                            return [4 /*yield*/, this.ProcessResult(recsess, help, null, null)];
                        case 4:
                            _a.sent();
                            return [2 /*return*/];
                        case 5:
                            ...
                            if (Command_1.Command.IsCueCommand(userInput)) {
                                CommandHandler_1.CommandHandler.HandleCueCommand(context, userInput, function (responses, teachAction, actionData) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                    return tslib_1.__generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4 /*yield*/, this.ProcessResult(recsess, responses, null, null, teachAction, actionData)];
                                            case 1:
                                                _a.sent();
                                                return [2 /*return*/];
                                        }
                            ...
                            return [4 /*yield*/, memory.CueCommand()];
                        case 6:
                            cueCommand = _a.sent();
                            if (cueCommand) {
                        ...
                        case 8:
                            _a.sent();
                            return [2 /*return*/];
                        case 9: return [4 /*yield*/, memory.SessionId()];
                        case 10:
                            sessionId = _a.sent();
                        ...
                        case 11:
                            _a.sent();
                            return [2 /*return*/];
                        case 12: return [4 /*yield*/, memory.InTeachAsync()];
                        case 13:
                            inTeach = _a.sent();
                            if (!inTeach) return [3 /*break*/, 22];
                            return [4 /*yield*/, memory.LastStep(Consts_1.SaveStep.CHOICES)];
                        case 14:
                            choices = _a.sent();
                            ...
                            return [4 /*yield*/, this.ProcessResult(recsess, [msg], null, null)];
                        case 15:
                            _a.sent();
                            return [2 /*return*/];
                        case 16:
                            actionId = choices[userInput];
                            return [4 /*yield*/, memory.SetLastStep(Consts_1.SaveStep.CHOICES, null)];
                        case 17:
                            _a.sent();
                            BlisDebug_1.BlisDebug.Log("TT: Choose Action", "flow");
                            return [4 /*yield*/, this.TakeTurn(recsess, null, actionId)];
                        case 18:
                            _a.sent();
                            return [3 /*break*/, 21];
                        case 19:
                            BlisDebug_1.BlisDebug.Log("TT: Choose Action", "flow");
                            return [4 /*yield*/, this.TakeTurn(recsess, userInput, null)];
                        case 20:
                            _a.sent();
                            _a.label = 21;
                        case 21: return [3 /*break*/, 25];
                        case 22: return [4 /*yield*/, memory.SetLastStep(Consts_1.SaveStep.INPUT, userInput)];
                        case 23:
                            _a.sent();
                        ...
                        case 26:
                            if (session.message.attachments && session.message.attachments.length > 0) {
                                ...
                                BlisAppContent_1.BlisAppContent.ImportAttachment(context, session.message.attachments[0], function (text) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                    return tslib_1.__generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4 /*yield*/, this.ProcessResult(recsess, [text], null, null)];
                                            case 1:
                                                _a.sent();
                                                return [2 /*return*/];
                                        }
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.TakeTurnCallback(recsess, response_1)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                    case 3: return [4 /*yield*/, memory.ModelId()];
                    case 4:
                        modelId = _a.sent();
                        return [4 /*yield*/, memory.InTeachAsync()];
                    case 5:
                        ...
                        return [4 /*yield*/, this.TakeTurnCallback(recsess, response_2)];
                    case 6:
                        _a.sent();
                        return [2 /*return*/];
                    case 7: return [4 /*yield*/, memory.SessionId()];
                    case 8:
                        sessionId = _a.sent();
                        if (!!sessionId) return [3 /*break*/, 10];
                        response_3 = this.ErrorResponse(Menu_1.Menu.Home("The app has not been started"));
                        return [4 /*yield*/, this.TakeTurnCallback(recsess, response_3)];
                    case 9:
                        _a.sent();
                        return [2 /*return*/];
                    case 10:
                    ...
                    case 11:
                        ...
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.SendTurnRequest(appId, sessionId, requestBody)];
                    case 12:
                        ...
                        return [4 /*yield*/, this.TakeTurnCallback(recsess, response)];
                    case 13:
                        _a.sent();
                        return [2 /*return*/];
                    case 14:
                    ...
                    case 15:
                        ...
                        return [3 /*break*/, 18];
                    case 16: return [4 /*yield*/, this.PromisifyLC(this.DefaultLuisCallback, takeTurnResponse.originalText, takeTurnResponse.entities, memory_1)];
                    case 17:
                        takeTurnRequest = _a.sent();
                        _a.label = 18;
                    case 18:
                    ...
                    case 22:
                        ...
                        if (!(action.actionType == Consts_1.ActionTypes.TEXT)) return [3 /*break*/, 29];
                        return [4 /*yield*/, this.TakeTurnCallback(recsess, takeTurnResponse)];
                    case 23:
                        _a.sent();
                        if (!!action.waitAction) return [3 /*break*/, 26];
                        memory_3 = recsess.context.Memory();
                        return [4 /*yield*/, memory_3.EntityIds()];
                    case 24:
                        entityIds = _a.sent();
                    ...
                    case 26:
                        ...
                        return [4 /*yield*/, memory_2.FinishTrainStep()];
                    case 27:
                        _a.sent();
                        _a.label = 28;
                    case 28: return [2 /*return*/];
                    case 29:
                        if (!(action.actionType == Consts_1.ActionTypes.API)) return [3 /*break*/, 44];
                        ...
                        return [4 /*yield*/, memory_2.GetEntities(iArgs)];
                    case 30:
                        entities = _a.sent();
                        return [4 /*yield*/, this.ProcessResult(recsess, null, intentName, entities)];
                    case 31:
                        _a.sent();
                        return [4 /*yield*/, memory_2.SetTrainStep(Consts_1.SaveStep.APICALLS, intentName + " " + entities)];
                    case 32:
                        _a.sent();
                        return [2 /*return*/];
                    case 33: return [4 /*yield*/, memory_2.SubstituteEntities(args)];
                    case 34:
                    ...
                    case 35:
                        ...
                        return [4 /*yield*/, memory_2.SetTrainStep(Consts_1.SaveStep.APICALLS, apiName + " " + args)];
                    case 36:
                        _a.sent();
                        _a.label = 37;
                    case 37:
                    ...
                    case 42:
                        ...
                        return [4 /*yield*/, this.TakeTurnCallback(recsess, response_4)];
                    case 43:
                        _a.sent();
                        _a.label = 44;
                    ...
                    case 45:
                        ...
                        return [4 /*yield*/, this.TakeTurnCallback(recsess, null, errMsg)];
                    case 46:
                        _a.sent();
                        return [3 /*break*/, 47];
    ...
    BlisRecognizer.prototype.CallAzureFuncCB = function (context, memory, args) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!!BlisClient_1.BlisClient.client.azureFunctionsUrl) return [3 /*break*/, 1];
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, AzureFunctions_1.AzureFunctions.Call(BlisClient_1.BlisClient.client.azureFunctionsUrl, BlisClient_1.BlisClient.client.azureFunctionsKey, funct, query)];
                    case 2:
                        output = _b.sent();
                        if (output) {
                        ...
                        _b.label = 3;
                    case 3: return [4 /*yield*/, memory.EntityIds()];
                    case 4:
                        entityIds = _b.sent();
                        return [4 /*yield*/, memory.SetLastStep(Consts_1.SaveStep.RESPONSES, args)];
                    case 5:
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, memory.EntityIds()];
                    case 1:
                        entityIds = _a.sent();
                        return [2 /*return*/, new TakeTurnRequest_1.TakeTurnRequest({ entities: entityIds })];
                }
    ...
    BlisRecognizer.prototype.ClearTaskCB = function (context, memory, entityName) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, memory.ForgetEntityByName(entityName, null)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, memory.EntityIds()];
                    case 2:
    ...
    BlisRecognizer.prototype.DefaultLuisCallback = function (text, entities, memory, done) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, memory.ForgetEntityLabel(entity)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 5];
                    case 3: return [4 /*yield*/, memory.RememberEntityLabel(entity)];
                    case 4:
                        _a.sent();
                        _a.label = 5;
                    case 5:
                        if (!(entity.metadata && entity.metadata.task)) return [3 /*break*/, 8];
                        return [4 /*yield*/, memory.WasRemembered(entity.metadata.task)];
                    case 6:
                        remembered = _a.sent();
                    ...
                    case 8:
                        _i++;
                        return [3 /*break*/, 1];
                    case 9: return [4 /*yield*/, memory.EntityIds()];
                    case 10:
                        entityIds = _a.sent();
    ...
    BlisRecognizer.prototype.DefaultBlisCallback = function (text, memory, done) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var outText;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, memory.Substitute(text)];
                    case 1:
                        outText = _a.sent();
                        done(outText);
                        return [2 /*return*/];
