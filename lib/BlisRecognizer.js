        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                try {
                    ...
                    this.blisClient = new BlisClient_1.BlisClient(options.serviceUri, options.user, options.secret, options.azureFunctionsUrl, options.azureFunctionsKey);
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, AzureFunctions_1.AzureFunctions.Call(context.client.azureFunctionsUrl, context.client.azureFunctionsKey, funct, query)];
                    case 2:
                        output = _b.sent();
                        if (output) {
