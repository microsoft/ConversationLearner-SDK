...
var BlisRecognizer = (function () {
    ...
    BlisRecognizer.prototype.LoadUser = function (address, cb) {
        ...
        BlisUserState_1.BlisUserState.Get(this.bot, address, this.defaultApp, function (error, userState, isNew) {
            if (isNew) {
                ...
                BlisAppContent_1.BlisAppContent.Load(_this.blisClient, userState, address, _this.defaultApp, function (text) {
    ...
    BlisRecognizer.prototype.HandleEditCommand = function (input, address, userState, cb) {
        ...
        try {
            ...
            if (editCommand.commandName == Consts_1.Commands.EDITACTION) {
                ...
                var _a = input.split(' '), name_1 = _a[0], type = _a[1];
                Entity_1.Entity.Add(this.blisClient, userState, editCommand.id /*entityId*/, name_1, type, function (responses) {
                    cb(responses);
                });
            }
        }
    ...
    BlisRecognizer.prototype.HandleCommand = function (input, address, userState, cb) {
        ...
        if (command == Consts_1.Commands.ACTIONS) {
            ...
            Entity_1.Entity.Add(this.blisClient, userState, null, arg, arg2, function (responses) {
                cb(responses, true);
            });
        }
            ...
            Entity_1.Entity.Get(this.blisClient, userState, arg_1, function (responses) {
                cb(responses);
            });
        }
            ...
            if (command == Consts_1.Commands.ADDAPIACTION) {
                ...
                Action_1.Action.Add(this.blisClient, userState, arg_2, Consts_1.ActionTypes.API, null, function (responses) {
                    cb(responses);
                });
            }
            else if (command == Consts_1.Commands.ADDTEXTACTION) {
                var arg_3 = this.RemoveCommandWord(input);
                Action_1.Action.Add(this.blisClient, userState, arg_3, Consts_1.ActionTypes.TEXT, null, function (responses) {
                    cb(responses);
                });
            }
                ...
                Entity_1.Entity.Delete(this.blisClient, userState, arg, function (responses) {
                    cb(responses);
                });
            }
                ...
                Entity_1.Entity.Add(this.blisClient, userState, arg /*entityId*/, arg2, arg3, function (responses) {
                    cb(responses);
                });
            }
            else if (command == Consts_1.Commands.EXPORTAPP) {
                BlisAppContent_1.BlisAppContent.Export(this.blisClient, userState, address, this.bot, function (text) {
                    cb([text]);
                });
            }
            else if (command == Consts_1.Commands.IMPORTAPP) {
                Utils_1.Utils.SendMessage(this.bot, address, "Importing app...");
                BlisAppContent_1.BlisAppContent.Import(this.blisClient, userState, address, arg, function (text) {
                    cb([text]);
                });
            }
            else if (command == Consts_1.Commands.LOADAPP) {
                Utils_1.Utils.SendMessage(this.bot, address, "Loading app...");
                BlisAppContent_1.BlisAppContent.Load(this.blisClient, userState, address, arg, function (text) {
                    cb([text]);
                });
            }
        ...
        try {
            ...
            this.LoadUser(address_1, function (error, userState) {
                if (context.message.attachments && context.message.attachments.length > 0) {
                    ...
                    BlisAppContent_1.BlisAppContent.ImportAttachment(_this.blisClient, userState, address_1, context.message.attachments[0], function (text) {
    ...
    BlisRecognizer.prototype.TakeTurn = function (userState, payload, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var card, response_1, card, response_2, card, response_3, expectedNextModes, requestBody, takeTurnResponse, response, takeTurnRequest, memory, action, apiString, _a, apiName, arg, api, memory, takeTurnRequest, response_4, error_5, errMsg;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (userState[Consts_1.UserStates.APP] == null) {
                            card = Utils_1.Utils.MakeHero("No Application has been loaded..", null, null, {
                                "My Apps": "" + Consts_1.Commands.APPS,
                                "Help": "" + Consts_1.Commands.HELP,
                            });
                            response_1 = this.ErrorResponse(card);
                            cb(response_1);
                            return [2 /*return*/];
                        }
                        else if (!userState[Consts_1.UserStates.MODEL] && !userState[Consts_1.UserStates.TEACH]) {
                            card = Utils_1.Utils.MakeHero("This application needs to be trained first.", null, null, {
                                "Teach": "" + Consts_1.Commands.TEACH,
                                "Help": "" + Consts_1.Commands.HELP,
                            });
                            response_2 = this.ErrorResponse(card);
                            cb(response_2);
                            return [2 /*return*/];
                        }
                        else if (!userState[Consts_1.UserStates.SESSION]) {
                            card = Utils_1.Utils.MakeHero("Start the app or add more training dialogs first.", null, null, {
                                "Start": "" + Consts_1.Commands.START,
                                "Teach": "" + Consts_1.Commands.TEACH
                            });
                            response_3 = this.ErrorResponse(card);
                            cb(response_3);
                            return [2 /*return*/];
                        }
    ...
    BlisRecognizer.prototype.DefaultLuisCallback = function (text, entities, memory) {
        ...
        for (var _i = 0, entities_1 = entities; _i < entities_1.length; _i++) {
            ...
            if (entityName.startsWith(Consts_1.ActionCommand.NEGATIVE)) {
