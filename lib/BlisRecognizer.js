...
var BlisRecognizer = (function () {
    ...
    BlisRecognizer.prototype.EndSession = function (userState, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var sessionId, modelId, error_8, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
    ...
    BlisRecognizer.prototype.ExportApp = function (userState, address, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var dialogIds, blisapp, msg, error_9, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    BlisRecognizer.prototype.GetActions = function (userState, detail, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var actionIds, json, textactions, apiactions, _i, actionIds_1, actionId, action, memory, posstring, negstring, atext, name_1, msg, error_10, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    BlisRecognizer.prototype.GetApps = function (cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var appIds, json, msg, _i, appIds_2, appId, ajson, name_2, id, error_11, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    BlisRecognizer.prototype.GetEntities = function (userState, detail, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var entityIds, json, memory, msg, _i, entityIds_1, entityId, entity, error_12, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    BlisRecognizer.prototype.GetTrainDialogs = function (userState, address, searchTerm, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var blisApp, dialogs, responses, _i, dialogs_1, dialog, error_13, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
    ...
    BlisRecognizer.prototype.LoadApp = function (userState, address, appId, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var msg, loadedId, modelId, sessionId, error_14, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    BlisRecognizer.prototype.ImportApp = function (userState, address, appId, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var importApp, mergedApp, memory, error_15, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    BlisRecognizer.prototype.ImportAppAttachment = function (userState, address, attachment, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var text, json, blisApp, newApp, memory, error_16, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    BlisRecognizer.prototype.NewSession = function (userState, teach, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var endId, sessionId, body, subtext, card, error_17, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    BlisRecognizer.prototype.TakeTurn = function (userState, payload, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var response_1, response_2, response_3, expectedNextModes, requestBody, takeTurnResponse, response, takeTurnRequest, memory, action, apiString, _a, apiName, arg, api, memory, takeTurnRequest, response_4, error_18, errMsg;
