...
var BlisRecognizer = (function () {
    ...
    BlisRecognizer.prototype.AddAction = function (userState, content, actionType, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _this = this;
            var memory, msg, msg, firstNeg, firstPos, cut, actionText, negIds, posIds, negNames, posNames, words, _i, words_1, word, posName, posID, negName, negID, posName, posID;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        dialogIds = [];
                        fail = null;
                        return [4 /*yield*/, this.blisClient.ExportApp(userState)
                                .then(function (json) {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        userState[Consts_1.UserStates.LASTINPUT] = null;
                    ...
                    case 0:
                        ...
                        return [4 /*yield*/, this.ReadFromFile(attachment.contentUrl)
                                ...
                                try {
                                    ...
                                    _this.blisClient.ImportApp(userState, json)
    ...
    BlisRecognizer.prototype.TrainOnImport = function (userState, blisApp) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var fail;
            return tslib_1.__generator(this, function (_a) {
                fail = null;
        ...
        if (userState[Consts_1.UserStates.TEACH] && (command != Consts_1.Commands.DUMP) && (command != "!debug") && (command != Consts_1.Commands.TEACH)) {
            ...
            if (command == Consts_1.Commands.ACTIONS) {
                ...
                this.AddAction(userState, start, Consts_1.ActionTypes.API, function (responses) {
                    _this.SendResult(address, userState, cb, responses);
                });
            }
                ...
                this.SendResult(address, userState, cb, ["_I wasn't in teach mode. Type _" + Consts_1.Commands.TEACH + "_ to begin teaching_"]);
            }
                ...
                this.SendResult(address, userState, cb, ["Debug " + (BlisDebug_1.BlisDebug.enabled ? "Enabled" : "Disabled")]);
            }
                ...
                if (memory.HasEntities()) {
                    ...
                    this.NewSession(userState, true, function (results) {
                        _this.SendResult(address, userState, cb, results);
                    });
                }
                else {
    ...
    BlisRecognizer.prototype.HandleIntCommand = function (input, address, userState, cb) {
        ...
        if (userState[Consts_1.UserStates.TEACH]) {
            if (command == Consts_1.IntCommands.SAVETEACH) {
                ...
                var memory = new BlisMemory_1.BlisMemory(userState);
                var dialog = memory.GetTrainSteps();
                var msg = "** New Dialog Summary **\n\n";
                msg += "-----------------------------\n\n";
                for (var _i = 0, dialog_1 = dialog; _i < dialog_1.length; _i++) {
                    var trainstep = dialog_1[_i];
                    msg += trainstep.input;
                    if (trainstep.entity) {
            ...
            this.LoadUser(address_1, function (error, userState) {
                ...
                if (context.message.text) {
                    ...
                    if (userInput_1.startsWith('!')) {
                        _this.HandleCommand(userInput_1, address_1, userState, cb);
                    }
                        ...
                        _this.blisClient.TakeTurn(userState, userInput_1, function (response) {
                            var responses = [];
                            if (response.mode == Consts_1.TakeTurnModes.TEACH) {
                                if (response.teachStep == Consts_1.TeachStep.LABELENTITY) {
                                    if (response.teachError) {
                                        ...
                                        responses.push(_this.MakeHero(title, body, null, null));
                                    }
                                    else {
                                        memory_1.SaveTrainStep(Consts_1.SaveStep.INPUT, userInput_1);
                                    }
                                    ...
                                    if (response.teachLabelEntities.length == 0) {
                                        ...
                                        responses.push(_this.MakeHero(cardtitle, cardsub, cardtext, { "None": "1", "Help": Help_1.Help.PICKENTITY }));
                                    }
                                    else {
                                        var entities = "";
                                        ...
                                        responses.push(_this.MakeHero(cardtitle, null, body, { "Correct": "1", "Help": Help_1.Help.PICKENTITY }));
                                    }
                                }
                                else if (response.teachStep == Consts_1.TeachStep.LABELACTION) {
                                    memory_1.SaveTrainStep(Consts_1.SaveStep.ENTITY, memory_1.DumpEntities());
                                    var title = "Teach Step: Select Action";
                                    var body = memory_1.DumpEntities() + "\n\n";
                                    responses.push(_this.MakeHero(title, null, body, null));
                                    if (response.teachLabelActions.length == 0) {
                                        ...
                                        responses.push(msg);
                                        responses.push(_this.MakeHero(" ", null, 'Select Action by number or enter a new one', { "Help": Help_1.Help.ADDACTION }));
                                    }
                                }
                                else {
                                ...
                                if (inTeach_1) {
                                    memory_1.SaveTrainStep(Consts_1.SaveStep.RESPONSE, outText);
                                    responses.push(_this.MakeHero('Trained Response:', outText + "\n\n", "Type next user input for this Dialog or", { "Dialog Complete": Consts_1.IntCommands.DONETEACH }));
                                }
                                else {
                                    responses.push(outText);
                                    memory_1.SetLastInput(userInput_1);
                                }
                            }
