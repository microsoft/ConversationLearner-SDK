...
var BlisRecognizer = (function () {
    ...
    BlisRecognizer.prototype.TrainOnSnippetList = function (recognizer, sniplist) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var fail, actionList, actiontext2id, _i, sniplist_1, snippet, _loop_3, this_3, _a, _b, turn, _c, sniplist_2, snippet, dialog, _d, _e, turn, altTexts, userText, i, actionId, input, newturn, _f;
            return tslib_1.__generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 1:
                        ...
                        _loop_3 = function (turn) {
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        if (!(actionList.indexOf(turn.action) == -1)) return [3 /*break*/, 3];
                                        _a.label = 1;
                                    case 1:
                                        if (!!fail) return [3 /*break*/, 3];
                    ...
                    case 6:
                        ...
                        _g.label = 7;
                    case 7:
                        if (!(_c < sniplist_2.length)) return [3 /*break*/, 11];
