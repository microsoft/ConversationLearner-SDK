    ...
    BlisRecognizer.prototype.ProcessResult = function (recsess, responses, intent, entities, teachAction, actionData) {
        ...
        if (inTeach && teachAction) {
            if (teachAction == Consts_1.TeachAction.RETRAIN) {
                ...
                // Retrain the model
                BlisClient_1.BlisClient.client.Retrain(recsess.context.State(Consts_1.UserStates.APP), recsess.context.State(Consts_1.UserStates.SESSION))
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 10:
                        _a.sent();
                        memory.RememberTrainStep(Consts_1.SaveStep.APICALLS, intentName + " " + entities);
                        return [2 /*return*/];
                    case 11:
