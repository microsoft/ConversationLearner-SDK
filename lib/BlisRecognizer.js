...
var BlisRecognizer = (function () {
    ...
    BlisRecognizer.prototype.RemoveInternalAPIs = function (labelActions) {
        var outActions = [];
        var sumScore = 0;
        for (var _i = 0, labelActions_1 = labelActions; _i < labelActions_1.length; _i++) {
            var labelAction = labelActions_1[_i];
        ...
        if (sumScore <= 0)
            return outActions;
        for (var _a = 0, outActions_1 = outActions; _a < outActions_1.length; _a++) {
            var labelAction = outActions_1[_a];
