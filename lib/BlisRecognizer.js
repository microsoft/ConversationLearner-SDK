...
var BlisRecognizer = (function () {
    ...
    BlisRecognizer.prototype.GetActions = function (userState, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
    ...
    BlisRecognizer.prototype.GetEntities = function (userState, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.GetEntities(userState, function (text) {
                ...
                this.LoadUser(address_1, function (error, userState) {
                    ...
                    if (command.startsWith('!')) {
                        if (userState[Consts_1.UserStates.TEACH] && (command != "!dump") && (command != "!debug")) {
                            if (command == "!done") {
                                _this.EndSession(userState, function (text) {
                            ...
                            if (command == "!actions") {
                                _this.GetActions(userState, function (text) {
                                    _this.SendResult(address_1, userState, cb, text);
                                });
                            }
                            else if (command == "!addentity") {
                                _this.AddEntity(userState, arg, arg2, arg3, function (text) {
                                    _this.SendResult(address_1, userState, cb, text);
                                });
                            }
                            else if (command == "!apps") {
                                _this.GetApps(function (text) {
                                    _this.SendResult(address_1, userState, cb, text);
                                });
                            }
                            else if (command == "!createapp") {
                                _this.CreateApp(userState, arg, arg2, function (text) {
                                    _this.SendResult(address_1, userState, cb, text);
                                });
                            }
                            else if (command == "!deleteallapps") {
                                _this.DeleteAllApps(userState, function (text) {
                                    _this.SendResult(address_1, userState, cb, text);
                                });
                            }
                            else if (command == "!deleteaction") {
                                _this.DeleteAction(userState, arg, function (text) {
                                    _this.SendResult(address_1, userState, cb, text);
                                });
                            }
                                ...
                                _this.DeleteApp(userState, arg, function (text) {
                                    _this.SendResult(address_1, userState, cb, text);
                                });
                            }
                                ...
                                _this.SendResult(address_1, userState, cb, "Debug " + (BlisDebug_1.BlisDebug.enabled ? "Enabled" : "Disabled"));
                            }
                                ...
                                var memory = new BlisMemory_1.BlisMemory(userState);
                                _this.SendResult(address_1, userState, cb, memory.Dump());
                            }
                            else if (command == "!entities") {
                                _this.GetEntities(userState, function (text) {
                                    _this.SendResult(address_1, userState, cb, text);
                                });
                            }
                                ...
                                _this.LoadApp(userState, arg, function (text) {
                                    _this.SendResult(address_1, userState, cb, text);
                                });
                            }
                            else if (command == "!start") {
                                _this.NewSession(userState, false, function (text) {
                                    _this.SendResult(address_1, userState, cb, text);
                                });
                            }
                            else if (command == "!teach") {
                                _this.NewSession(userState, true, function (text) {
                                    _this.SendResult(address_1, userState, cb, text);
                                });
                            }
                            else if (command == "!trainfromurl") {
                                _this.TrainFromFile(userState, arg, function (text) {
                                    _this.SendResult(address_1, userState, cb, text);
                                });
                            }
                            else if (command == "!traindialogs") {
                                _this.GetTrainDialogs(userState, address_1, function (text) {
                                    _this.SendResult(address_1, userState, cb, text);
                                });
                            }
