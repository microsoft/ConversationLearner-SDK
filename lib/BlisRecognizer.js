...
var BlisRecognizer = (function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.blisClient.AddAction(userState, apiCall, Consts_1.ActionTypes.API, [], [saveId])
                    ...
                    case 1:
                        ...
                        _a.sent();
                        _a.label = 2;
                    case 2: return [4 /*yield*/, this.blisClient.AddAction(userState, actionText, actionType, posIds, negIds)
                            .then(function (actionId) {
                            var substr = "";
                            if (posIds.length > 0) {
    ...
    BlisRecognizer.prototype.GetTrainDialogs = function (userState, address, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.blisClient.ExportApp(userState)
                            .then(function (blisApp) {
                            // Xform into text
                            if (address.channelId == "emulator") {
                                ...
                                _this.SendAsAttachment(address, JSON.stringify(blisApp));
                                cb("");
                            }
                        })
                            .catch(function (error) { return cb(error); })];
                    ...
                    if (userInput_1.startsWith('!')) {
                        _this.HandleCommand(userInput_1, address_1, userState, function (responses, retrain) {
                            ...
                            if (inTeach_1 && retrain) {
                                ...
                                // Retrain the model
                                _this.blisClient.Retrain(userState)
