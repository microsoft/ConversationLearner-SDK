...
var BlisRecognizer = (function () {
    ...
    BlisRecognizer.prototype.AddAction = function (userState, content, actionType, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var error, commandHelp, msg, firstNeg, firstPos, cut, actionText, memory, negIds, posIds, negNames, posNames, saveName, saveId, words, _i, words_1, word, posName, posID, negName, negID, posName, posID, saveAPI, apiCall, apiActionId, actionId, substr, card, error_1, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        saveName = null;
                        saveId = null;
                        words = Action_1.Action.Split(content);
                    ...
                    case 5:
                        error_1 = _a.sent();
                        errMsg = this.ErrorString(error_1);
                        BlisDebug_1.BlisDebug.Error(errMsg);
                        cb([errMsg]);
                        return [3 /*break*/, 6];
    ...
    BlisRecognizer.prototype.AddEntity = function (userState, entityName, entityType, prebuiltName, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var error, msg, msg, msg, entityId, memory, card, error_2, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 3:
                        error_2 = _a.sent();
                        errMsg = this.ErrorString(error_2);
                        BlisDebug_1.BlisDebug.Error(errMsg);
                        cb([errMsg]);
                        return [3 /*break*/, 4];
    ...
    BlisRecognizer.prototype.CreateApp = function (userState, appName, luisKey, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var msg, msg, appId, card, error_3, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 3:
                        error_3 = _a.sent();
                        errMsg = this.ErrorString(error_3);
                        BlisDebug_1.BlisDebug.Error(errMsg);
                        cb([errMsg]);
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/];
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_4 = _a.sent();
                        errMsg = this.ErrorString(error_4);
                        BlisDebug_1.BlisDebug.Error(errMsg);
                        cb(errMsg);
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/];
    ...
    BlisRecognizer.prototype.DeleteAllApps = function (userState, address, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var appIds, json, _i, appIds_1, appId, text, error_5, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 7:
                        error_5 = _a.sent();
                        errMsg = this.ErrorString(error_5);
                        BlisDebug_1.BlisDebug.Error(errMsg);
                        cb([errMsg]);
                        return [3 /*break*/, 8];
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_6 = _a.sent();
                        errMsg = this.ErrorString(error_6);
                        BlisDebug_1.BlisDebug.Error(errMsg);
                        cb(errMsg);
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/];
    ...
    BlisRecognizer.prototype.DeleteEntity = function (userState, entityId, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var msg, error_7, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        // TODO clear savelookup
                        return [4 /*yield*/, this.blisClient.DeleteEntity(userState[Consts_1.UserStates.APP], entityId)];
                    case 2:
                        // TODO clear savelookup
                        _a.sent();
                    ...
                    case 3:
                        error_7 = _a.sent();
                        errMsg = this.ErrorString(error_7);
                        BlisDebug_1.BlisDebug.Error(errMsg);
                        cb(errMsg);
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/];
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_8 = _a.sent();
                        errMsg = this.ErrorString(error_8);
                        BlisDebug_1.BlisDebug.Error(errMsg);
                        cb(errMsg);
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/];
    ...
    BlisRecognizer.prototype.EndSession = function (userState, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var sessionId, modelId, error_9, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        error_9 = _a.sent();
                        errMsg = this.ErrorString(error_9);
                        BlisDebug_1.BlisDebug.Error(errMsg);
                        cb(errMsg);
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/];
    ...
    BlisRecognizer.prototype.ExportApp = function (userState, address, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var dialogIds, blisapp, msg, error_10, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 3:
                        error_10 = _a.sent();
                        errMsg = this.ErrorString(error_10);
                        BlisDebug_1.BlisDebug.Error(errMsg);
                        cb(errMsg);
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/];
    ...
    BlisRecognizer.prototype.GetActions = function (userState, detail, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var actionIds, json, textactions, apiactions, _i, actionIds_1, actionId, action, memory, posstring, negstring, atext, name_1, msg, error_11, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 4:
                        ...
                        if (posstring.length > 0) {
                            atext += "  " + Consts_1.ActionCommand.REQUIRE + "[" + posstring + "]";
                        }
                        if (negstring.length > 0) {
                            atext += "  " + Consts_1.ActionCommand.BLOCK + "[" + negstring + "]";
                        }
                    ...
                    case 7:
                        error_11 = _a.sent();
                        errMsg = this.ErrorString(error_11);
                        BlisDebug_1.BlisDebug.Error(errMsg);
                        cb(errMsg);
                        return [3 /*break*/, 8];
                    case 8: return [2 /*return*/];
    ...
    BlisRecognizer.prototype.GetApps = function (cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var appIds, json, msg, _i, appIds_2, appId, ajson, name_2, id, error_12, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 7:
                        error_12 = _a.sent();
                        errMsg = this.ErrorString(error_12);
                        BlisDebug_1.BlisDebug.Error(errMsg);
                        cb(errMsg);
                        return [3 /*break*/, 8];
                    case 8: return [2 /*return*/];
    ...
    BlisRecognizer.prototype.GetEntities = function (userState, detail, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var entityIds, json, memory, msg, _i, entityIds_1, entityId, entity, error_13, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 7:
                        error_13 = _a.sent();
                        errMsg = this.ErrorString(error_13);
                        BlisDebug_1.BlisDebug.Error(errMsg);
                        cb(errMsg);
                        return [3 /*break*/, 8];
                    case 8: return [2 /*return*/];
    ...
    BlisRecognizer.prototype.GetTrainDialogs = function (userState, address, searchTerm, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var blisApp, dialogs, responses, _i, dialogs_1, dialog, error_14, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        error_14 = _a.sent();
                        errMsg = this.ErrorString(error_14);
                        BlisDebug_1.BlisDebug.Error(errMsg);
                        cb(errMsg);
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/];
    ...
    BlisRecognizer.prototype.LoadApp = function (userState, address, appId, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var msg, loadedId, numActions, modelId, sessionId, error_15, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 5:
                        modelId = _a.sent();
                        if (!!userState[Consts_1.UserStates.MODEL]) return [3 /*break*/, 7];
                    ...
                    case 9:
                        error_15 = _a.sent();
                        errMsg = this.ErrorString(error_15);
                        BlisDebug_1.BlisDebug.Error(errMsg);
                        cb(errMsg);
                        return [3 /*break*/, 10];
    ...
    BlisRecognizer.prototype.SwapEntities = function (entityIds, swapList) {
    ...
    /** Merge entites */
    BlisRecognizer.prototype.MergeEntities = function (app1, app2) {
    ...
    BlisRecognizer.prototype.ImportApp = function (userState, address, appId, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var currentApp, mergeApp, finalApp, memory, error_16, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        currentApp = _a.sent();
                        return [4 /*yield*/, this.blisClient.ExportApp(appId)];
                    case 3:
                        mergeApp = _a.sent();
                        // Merge any duplicate entities
                        mergeApp = this.MergeEntities(currentApp, mergeApp);
                        return [4 /*yield*/, this.blisClient.ImportApp(userState[Consts_1.UserStates.APP], mergeApp)];
                    case 4:
                        finalApp = _a.sent();
                        memory = new BlisMemory_1.BlisMemory(userState);
                        this.LoadApp(userState, address, memory.AppId(), function (text) {
                            cb(text);
                        });
                        return [3 /*break*/, 6];
                    case 5:
                        error_16 = _a.sent();
                        errMsg = this.ErrorString(error_16);
                        BlisDebug_1.BlisDebug.Error(errMsg);
                        cb(errMsg);
                        return [3 /*break*/, 6];
                    case 6: return [2 /*return*/];
    ...
    BlisRecognizer.prototype.ImportAppAttachment = function (userState, address, attachment, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var text, json, blisApp, newApp, memory, error_17, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 4:
                        error_17 = _a.sent();
                        errMsg = this.ErrorString(error_17);
                        BlisDebug_1.BlisDebug.Error(errMsg);
                        cb(text);
                        return [3 /*break*/, 5];
    ...
    BlisRecognizer.prototype.NewSession = function (userState, teach, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var endId, sessionId, body, subtext, card, error_18, errMsg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 4:
                        error_18 = _a.sent();
                        errMsg = this.ErrorString(error_18);
                        BlisDebug_1.BlisDebug.Error(errMsg);
    ...
    BlisRecognizer.prototype.LoadUser = function (address, cb) {
        ...
        BlisUserState_1.BlisUserState.Get(this.bot, address, this.defaultApp, function (error, userState, isNew) {
            if (isNew) {
                ...
                _this.LoadApp(userState, address, _this.defaultApp, function (text) {
    ...
    BlisRecognizer.prototype.HandleCommand = function (input, address, userState, cb) {
        ...
        if (command == Consts_1.Commands.ACTIONS) {
            ...
            if (command == Consts_1.Commands.ADDAPIACTION) {
                ...
                this.AddAction(userState, arg_1, Consts_1.ActionTypes.API, function (responses) {
                    cb(responses);
                });
            }
            else if (command == Consts_1.Commands.ADDTEXTACTION) {
                var arg_2 = this.RemoveCommandWord(input);
                this.AddAction(userState, arg_2, Consts_1.ActionTypes.TEXT, function (responses) {
                    cb(responses);
                });
            }
                ...
                this.DeleteAllApps(userState, address, function (text) {
                    cb([text]);
                });
            }
                ...
                this.DeleteEntity(userState, arg, function (text) {
                    cb([text]);
                });
            }
            else if (command == Consts_1.Commands.EXPORTAPP) {
                this.ExportApp(userState, address, function (text) {
                    cb([text]);
                });
            }
            else if (command == Consts_1.Commands.IMPORTAPP) {
                this.ImportApp(userState, address, arg, function (text) {
                    cb([text]);
                });
            }
            else if (command == Consts_1.Commands.LOADAPP) {
                this.LoadApp(userState, address, arg, function (text) {
                    cb([text]);
                });
            }
        ...
        try {
            ...
            this.LoadUser(address_1, function (error, userState) {
                if (context.message.attachments && context.message.attachments.length > 0) {
                    ...
                    _this.ImportAppAttachment(userState, address_1, context.message.attachments[0], function (text) {
            ...
            var errMsg = this.ErrorString(error);
            BlisDebug_1.BlisDebug.Error(errMsg);
            cb(error, null);
        }
    };
    BlisRecognizer.prototype.TakeTurn = function (userState, payload, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var response_1, response_2, response_3, expectedNextModes, requestBody, takeTurnResponse, response, takeTurnRequest, memory, action, apiString, _a, apiName, arg, api, memory, takeTurnRequest, response_4, error_19, errMsg;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 10:
                        error_19 = _b.sent();
                        errMsg = this.ErrorString(error_19);
                        BlisDebug_1.BlisDebug.Error(errMsg);
                        cb(null, errMsg);
                        return [3 /*break*/, 11];
    ...
    BlisRecognizer.prototype.ErrorString = function (error) {
