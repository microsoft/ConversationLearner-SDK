        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                try {
                    ...
                    BlisClient_1.BlisClient_v1.Init(options.serviceUri, options.user, options.secret, options.azureFunctionsUrl, options.azureFunctionsKey);
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        if (teachAction == Consts_1.TeachAction.RETRAIN) {
                            ...
                            // Retrain the model
                            BlisClient_1.BlisClient_v1.client.Retrain(appId, sessionId)
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 6:
                            ...
                            if (Command_1.Command.IsTestCommand(userInput)) {
                                CommandHandler_1.CommandHandler.HandleTestCommand(context, userInput, function (responses, teachAction, actionData) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                    return tslib_1.__generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4 /*yield*/, this.ProcessResult(recsess, responses, null, null, teachAction, actionData)];
                                            case 1:
