...
var BlisRecognizer = (function () {
    ...
    BlisRecognizer.prototype.InitDebug = function (bot) {
    ...
    BlisRecognizer.prototype.TrainOnSnippetList = function (recognizer, sniplist) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var fail, actionList, actiontext2id, _i, sniplist_1, snippet, _loop_1, this_1, _a, _b, turn, _c, sniplist_2, snippet, dialog, _d, _e, turn, altTexts, userText, i, actionId, input, newturn;
                            ...
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, this_1.blisClient.AddAction(turn.action, new Array(), new Array(), null)
