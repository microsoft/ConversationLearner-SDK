            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.AddApp(blisApp, null)];
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        Test.InitClient();
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.GetApps(null)];
                    case 1:
                        apps = _a.sent();
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        Test.InitClient();
                        inApp = Test.MakeApp();
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.AddApp(inApp, null)];
                    case 1:
                        appId = _a.sent();
