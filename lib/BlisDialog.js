...
var BlisDialog = (function (_super) {
    ...
    BlisDialog.prototype.TakeLocalAPIAction = function (scoredAction, memory) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var apiString, apiName, argString, argArray, _i, _a, word, _b, _c, api, output;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        argString = Utils_1.Utils.RemoveWords(apiString, 1);
                        argArray = [];
                        _i = 0, _a = argString.split(',');
                        _d.label = 1;
                    case 1:
                        ...
                        word = word.trim();
                        _c = (_b = argArray).push;
                        return [4 /*yield*/, memory.BotMemory().SubstituteEntities(word)];
                    case 2:
                        _c.apply(_b, [_d.sent()]);
                        _d.label = 3;
                    case 3:
