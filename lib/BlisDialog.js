...
var BlisDialog = (function (_super) {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        ...
                        _a.label = 7;
                    case 7: return [4 /*yield*/, this.ProcessExtraction(appId, sessionId, memory, extractResponse.text, extractResponse.predictedEntities)];
                    case 8:
                        _a.sent();
                        return [3 /*break*/, 11];
                    case 9:
                        ...
                        return [4 /*yield*/, Utils_1.Utils.SendText(this.bot, memory, msg)];
                    case 10:
                        _a.sent();
                        return [3 /*break*/, 11];
    ...
    BlisDialog.prototype.ProcessExtraction = function (appId, sessionId, memory, text, predictedEntities) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var scoreInput, scoreResponse, bestAction;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.CallLuisCallback(text, predictedEntities, memory)];
                    case 1:
                        scoreInput = _a.sent();
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.ProcessExtraction(appId, sessionId, memory, "", [])];
                    case 3:
                        _a.sent();
                        _a.label = 4;
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _a = actionType;
                        switch (_a) {
                            case blis_models_1.ActionTypes.TEXT: return [3 /*break*/, 2];
                            case blis_models_1.ActionTypes.CARD: return [3 /*break*/, 4];
                            case blis_models_1.ActionTypes.INTENT: return [3 /*break*/, 6];
                            case blis_models_1.ActionTypes.API_AZURE: return [3 /*break*/, 8];
                            case blis_models_1.ActionTypes.API_LOCAL: return [3 /*break*/, 10];
                        }
                        return [3 /*break*/, 12];
                    case 2: return [4 /*yield*/, this.TakeTextAction(scoredAction, memory)];
                    case 3:
                        _b.sent();
                        return [3 /*break*/, 12];
                    case 4: return [4 /*yield*/, this.TakeCardAction(scoredAction, memory)];
                    case 5:
                        _b.sent();
                        return [3 /*break*/, 12];
                    case 6: return [4 /*yield*/, this.TakeIntentAction(scoredAction, memory)];
                    case 7:
                        _b.sent();
                        return [3 /*break*/, 12];
                    case 8: return [4 /*yield*/, this.TakeAzureAPIAction(scoredAction, memory)];
                    case 9:
                        _b.sent();
                        return [3 /*break*/, 12];
                    case 10: return [4 /*yield*/, this.TakeLocalAPIAction(scoredAction, memory)];
                    case 11:
                        _b.sent();
                        return [3 /*break*/, 12];
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        outText = _a.sent();
                        return [4 /*yield*/, Utils_1.Utils.SendText(this.bot, memory, outText)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, Utils_1.Utils.SendText(this.bot, memory, output)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4: return [2 /*return*/];
