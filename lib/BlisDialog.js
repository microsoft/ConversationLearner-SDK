...
var BlisDialog = (function (_super) {
    ...
    BlisDialog.prototype.ProcessInput = function (session, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var context, memory, inTeach, app, sessionId, userInput, extractResponse, suggestedEntity, error_1, msg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 6:
                        ...
                        _a.label = 7;
                    case 7: return [4 /*yield*/, this.ProcessExtraction(app.appId, sessionId, memory, extractResponse.text, extractResponse.predictedEntities, extractResponse.definitions.entities)];
                    case 8:
                        _a.sent();
                        return [3 /*break*/, 11];
                    case 9:
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [3 /*break*/, 13];
                    case 3: return [4 /*yield*/, this.TakeTextAction(scoredAction, memory, allEntities)];
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 13];
                    case 5: return [4 /*yield*/, this.TakeCardAction(scoredAction, memory, allEntities)];
                    case 6:
                        _b.sent();
                        return [3 /*break*/, 13];
                    case 7: return [4 /*yield*/, this.TakeIntentAction(scoredAction, memory, allEntities)];
                    case 8:
                        _b.sent();
                        return [3 /*break*/, 13];
                    case 9: return [4 /*yield*/, this.TakeAzureAPIAction(scoredAction, memory, allEntities)];
                    case 10:
                        _b.sent();
                        return [3 /*break*/, 13];
                    case 11: return [4 /*yield*/, this.TakeLocalAPIAction(scoredAction, memory, allEntities)];
                    case 12:
                        _b.sent();
                        return [3 /*break*/, 13];
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        outText = null;
                        if (!this.luisCallback) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.blisCallback(scoredAction.payload, memoryManager)];
                    case 1:
                        outText = _a.sent();
                        return [3 /*break*/, 4];
