...
var BlisDialog = (function (_super) {
    ...
    BlisDialog.prototype.ProcessInput = function (session, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var context, memory, inTeach, appId, sessionId, userInput, extractResponse, error_1, msg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, this.ProcessExtraction(appId, sessionId, memory, extractResponse.text, extractResponse.predictedEntities)];
                    case 6:
                        _a.sent();
                        return [3 /*break*/, 9];
                    case 7:
